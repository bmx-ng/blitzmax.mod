...
Type TCompilerCBackend
	...
	Field currentEmbeddedRootFrame:Int
	...
	Function EmitRuntimeHeader:String(irModule:TCompilerIrModule, diagnostics:TCompilerDiagnostic[] Var)
		Local backend:TCompilerCBackend = New TCompilerCBackend
		Local result:String
		If irModule And CompilerEmbeddedTarget(irModule.targetPlatform) Then
			result = backend.EmitEmbeddedRuntimeHeaderModule(irModule)
		Else
			backend.runtimeTypes = True
	...
	Method EmitEmbeddedRuntimeHeaderModule:String(irModule:TCompilerIrModule)
		...
		result.Append("#include <blitzmax/embedded_runtime.h>~n")
		...
		result.Append(EmitEmbeddedStructDescriptorPrototypes(irModule))
	...
	Method EmitModule:String(irModule:TCompilerIrModule)
		...
		result.Append(EmitEmbeddedImportedClassLayouts(irModule))
		result.Append(EmitEmbeddedImportedConstructorPrototypes(irModule))
		result.Append(EmitEmbeddedImportedMethodPrototypes(irModule))
		result.Append(EmitEmbeddedFinalizerPrototypes(irModule))
		...
		result.Append(EmitEmbeddedVirtualPrototypes(irModule))
		result.Append(EmitEmbeddedStructDescriptors(irModule))
		result.Append(EmitEmbeddedInterfaceDescriptors(irModule))
		If EmbeddedObjectTypes() Then result.Append(EmitExternalPrototypes(irModule))
		result.Append(EmitEmbeddedClassLayouts(irModule))
		...
		AppendEmbeddedEnums(irModule, result)
		...
		Next
		result.Append(EmitEmbeddedObjectNewHelperPrototypes(irModule))
		...
		result.Append(EmitEmbeddedImplicitConstructors(irModule))
		result.Append(EmitEmbeddedBaseInitializers(irModule))
		result.Append(EmitEmbeddedObjectNewHelpers(irModule))
		result.Append(EmitEmbeddedFinalizers(irModule))
		result.Append(EmitEmbeddedBaseFinalizers(irModule))
		For Local routine:TCompilerIrFunction = EachIn irModule.functions
			If routine.isGlobalEntry Then Continue
	...
	Method EmitEmbeddedIncbinDeclarations:String(irModule:TCompilerIrModule)
	...
	Method EmitEmbeddedIncbinRegistration:String(indent:String)
	...
	Method EmbeddedStringTypes:Int()
		Return Not runtimeTypes And currentModule And CompilerEmbeddedTarget(currentModule.targetPlatform)
	End Method
	...
	Method EmbeddedStringRuntimeFunctionName:String(externalFunction:TCompilerIrExternalFunction)
		...
		Select abiName
			Case "bbStringCompare"; Return "bmx_embedded_string_compare"
			Case "bbStringEquals"; Return "bmx_embedded_string_equals"
			Case "bbStringHash"; Return "bmx_embedded_string_hash"
			Case "bbStringCompareCase"; Return "bmx_embedded_string_compare_case"
			Case "bbStringEqualsCase"; Return "bmx_embedded_string_equals_case"
			Case "bbStringHashCase"; Return "bmx_embedded_string_hash_case"
			Case "bbStringToString"; Return "bmx_embedded_string_to_string"
			Case "bbStringFind"; Return "bmx_embedded_string_find"
			Case "bbStringFindLast"; Return "bmx_embedded_string_find_last"
			Case "bbStringTrim"; Return "bmx_embedded_string_trim"
			Case "bbStringReplace"; Return "bmx_embedded_string_replace"
			Case "bbStringToLower"; Return "bmx_embedded_string_to_lower"
			Case "bbStringToUpper"; Return "bmx_embedded_string_to_upper"
			Case "bbStringStartsWith"; Return "bmx_embedded_string_starts_with"
			Case "bbStringEndsWith"; Return "bmx_embedded_string_ends_with"
			Case "bbStringContains"; Return "bmx_embedded_string_contains"
			Case "bbStringReplicate"; Return "bmx_embedded_string_replicate"
			Case "bbStringSplit"; Return "bmx_embedded_string_split"
			Case "bbStringJoin"; Return "bmx_embedded_string_join"
			Case "bbStringSplitInts"; Return "bmx_embedded_string_split_ints"
			Case "bbStringSplitBytes"; Return "bmx_embedded_string_split_bytes"
			Case "bbStringSplitShorts"; Return "bmx_embedded_string_split_shorts"
			Case "bbStringSplitUInts"; Return "bmx_embedded_string_split_uints"
			Case "bbStringSplitLongs"; Return "bmx_embedded_string_split_longs"
			Case "bbStringSplitULongs"; Return "bmx_embedded_string_split_ulongs"
			Case "bbStringSplitSizets"; Return "bmx_embedded_string_split_sizes"
			Case "bbStringSplitLongInts"; Return "bmx_embedded_string_split_long_ints"
			Case "bbStringSplitULongInts"; Return "bmx_embedded_string_split_ulong_ints"
			Case "bbStringSplitFloats"; Return "bmx_embedded_string_split_floats"
			Case "bbStringSplitDoubles"; Return "bmx_embedded_string_split_doubles"
			Case "bbStringJoinInts"; Return "bmx_embedded_string_join_ints"
			Case "bbStringJoinBytes"; Return "bmx_embedded_string_join_bytes"
			Case "bbStringJoinShorts"; Return "bmx_embedded_string_join_shorts"
			Case "bbStringJoinUInts"; Return "bmx_embedded_string_join_uints"
			Case "bbStringJoinLongs"; Return "bmx_embedded_string_join_longs"
			Case "bbStringJoinULongs"; Return "bmx_embedded_string_join_ulongs"
			Case "bbStringJoinSizets"; Return "bmx_embedded_string_join_sizes"
			Case "bbStringJoinLongInts"; Return "bmx_embedded_string_join_long_ints"
			Case "bbStringJoinULongInts"; Return "bmx_embedded_string_join_ulong_ints"
			Case "bbStringJoinFloats"; Return "bmx_embedded_string_join_floats"
			Case "bbStringJoinDoubles"; Return "bmx_embedded_string_join_doubles"
			Case "bbStringFromBytes"; Return "bmx_embedded_string_from_bytes"
			Case "bbStringFromShorts"; Return "bmx_embedded_string_from_shorts"
			Case "bbStringFromCString"; Return "bmx_embedded_string_from_c_string"
			Case "bbStringFromWString"; Return "bmx_embedded_string_from_w_string"
			Case "bbStringFromUTF8String"; Return "bmx_embedded_string_from_utf8_string"
			Case "bbStringFromUTF8Bytes"; Return "bmx_embedded_string_from_utf8_bytes"
			Case "bbStringToCString"; Return "bmx_embedded_string_to_c_string"
			Case "bbStringToWString"; Return "bmx_embedded_string_to_w_string"
			Case "bbStringToWStringBuffer"; Return "bmx_embedded_string_to_w_string_buffer"
			Case "bbStringToUTF8String"; Return "bmx_embedded_string_to_utf8_string"
			Case "bbStringToUTF8StringLen"; Return "bmx_embedded_string_to_utf8_string_len"
			Case "bbStringToUTF8StringBuffer"; Return "bmx_embedded_string_to_utf8_string_buffer"
			Case "bbStringToUTF32String"; Return "bmx_embedded_string_to_utf32_string"
			Case "bbStringFromUTF32String"; Return "bmx_embedded_string_from_utf32_string"
			Case "bbStringFromUTF32Bytes"; Return "bmx_embedded_string_from_utf32_bytes"
			Case "bbStringFromBytesAsHex"; Return "bmx_embedded_string_from_bytes_as_hex"
			Case "bbStringToBytesFromHex"; Return "bmx_embedded_string_to_bytes_from_hex"
			Case "bbStringToBytesFromHexEx"; Return "bmx_embedded_string_to_bytes_from_hex_ex"
			Case "bbStringFromInt"; Return "bmx_embedded_string_from_int32"
			Case "bbStringFromUInt"; Return "bmx_embedded_string_from_uint32"
			Case "bbStringFromLong"; Return "bmx_embedded_string_from_int64"
			Case "bbStringFromULong"; Return "bmx_embedded_string_from_uint64"
			Case "bbStringFromSizet"; Return "bmx_embedded_string_from_size"
			Case "bbStringFromLongInt"; Return "bmx_embedded_string_from_long"
			Case "bbStringFromULongInt"; Return "bmx_embedded_string_from_ulong"
			Case "bbStringFromFloat"; Return "bmx_embedded_string_from_float"
			Case "bbStringFromDouble"; Return "bmx_embedded_string_from_double"
			Case "bbStringToInt"; Return "bmx_embedded_string_to_int32"
			Case "bbStringToUInt"; Return "bmx_embedded_string_to_uint32"
			Case "bbStringToLong"; Return "bmx_embedded_string_to_int64"
			Case "bbStringToULong"; Return "bmx_embedded_string_to_uint64"
			Case "bbStringToSizet"; Return "bmx_embedded_string_to_size"
			Case "bbStringToLongInt"; Return "bmx_embedded_string_to_long"
			Case "bbStringToULongInt"; Return "bmx_embedded_string_to_ulong"
			Case "bbStringToFloat"; Return "bmx_embedded_string_to_float"
			Case "bbStringToDouble"; Return "bmx_embedded_string_to_double"
		End Select
		Return ""
	End Method

	Method EmbeddedScalarIntrinsicFunctionName:String(externalFunction:TCompilerIrExternalFunction)
		If Not EmbeddedStringTypes() Or Not externalFunction Then Return ""
		Local abiName:String = externalFunction.implementationAbiName
		If Not abiName.length Then abiName = externalFunction.abiName
		Select abiName
			Case "bbMilliSecs"; Return "bmx_embedded_millisecs"
			Case "bbDelay"; Return "bmx_embedded_delay"
			Case "bbUDelay"; Return "bmx_embedded_udelay"
			Case "brl_blitz_Max"; Return "bmx_embedded_max_i32"
			Case "brl_blitz_Max__Blong__Blong"; Return "bmx_embedded_max_i64"
			Case "brl_blitz_Max__Bfloat__Bfloat"; Return "bmx_embedded_max_f32"
			Case "brl_blitz_Max__Bdouble__Bdouble"; Return "bmx_embedded_max_f64"
			Case "brl_blitz_Max__Bbyte__Bbyte"; Return "bmx_embedded_max_u8"
			Case "brl_blitz_Max__Bshort__Bshort"; Return "bmx_embedded_max_u16"
			Case "brl_blitz_Max__Buint__Buint"; Return "bmx_embedded_max_u32"
			Case "brl_blitz_Max__Bulong__Bulong"; Return "bmx_embedded_max_u64"
			Case "brl_blitz_Max__Bsize_t__Bsize_t"; Return "bmx_embedded_max_size"
			Case "brl_blitz_Max__Blongint__Blongint"; Return "bmx_embedded_max_long"
			Case "brl_blitz_Max__Bulongint__Bulongint"; Return "bmx_embedded_max_ulong"
			Case "brl_blitz_Min__Bint__Bint"; Return "bmx_embedded_min_i32"
			Case "brl_blitz_Min__Blong__Blong"; Return "bmx_embedded_min_i64"
			Case "brl_blitz_Min__Bfloat__Bfloat"; Return "bmx_embedded_min_f32"
			Case "brl_blitz_Min__Bdouble__Bdouble"; Return "bmx_embedded_min_f64"
			Case "brl_blitz_Min__Bbyte__Bbyte"; Return "bmx_embedded_min_u8"
			Case "brl_blitz_Min__Bshort__Bshort"; Return "bmx_embedded_min_u16"
			Case "brl_blitz_Min__Buint__Buint"; Return "bmx_embedded_min_u32"
			Case "brl_blitz_Min__Bulong__Bulong"; Return "bmx_embedded_min_u64"
			Case "brl_blitz_Min__Bsize_t__Bsize_t"; Return "bmx_embedded_min_size"
			Case "brl_blitz_Min__Blongint__Blongint"; Return "bmx_embedded_min_long"
			Case "brl_blitz_Min__Bulongint__Bulongint"; Return "bmx_embedded_min_ulong"
			Case "brl_blitz_Abs__Bint"; Return "bmx_embedded_abs_i32"
			Case "brl_blitz_Abs__Blong"; Return "bmx_embedded_abs_i64"
			Case "brl_blitz_Abs__Bfloat"; Return "bmx_embedded_abs_f32"
			Case "brl_blitz_Abs__Bdouble"; Return "bmx_embedded_abs_f64"
			Case "brl_blitz_Sgn__Bint"; Return "bmx_embedded_sgn_i32"
			Case "brl_blitz_Sgn__Blong"; Return "bmx_embedded_sgn_i64"
			Case "brl_blitz_Sgn__Bfloat"; Return "bmx_embedded_sgn_f32"
			Case "brl_blitz_Sgn__Bdouble"; Return "bmx_embedded_sgn_f64"
		End Select
		Return ""
	End Method

	Method EmbeddedDesktopStringFunction:Int(externalFunction:TCompilerIrExternalFunction)
	...
	Method EmbeddedArrayElementSupported:Int(typeName:String)
		...
		If irEnum Then Return EmbeddedArrayElementSupported(irEnum.underlyingType)
		Local irStruct:TCompilerIrStruct = TCompilerIrStruct(structTypes.ValueForKey(normalized))
		If irStruct Then Return EmbeddedPlainStructSupported(irStruct)
		Local importedStruct:TCompilerIrImportedStruct = TCompilerIrImportedStruct(importedStructTypes.ValueForKey(normalized))
		If importedStruct Then Return EmbeddedPlainImportedStructSupported(importedStruct)
		Return normalized = "string" Or EmbeddedObjectStorageType(typeName)
	End Method

	Method EmbeddedPlainStructSupported:Int(irStruct:TCompilerIrStruct)
		...
		For Local irField:TCompilerIrStructField = EachIn irStruct.fields
			...
			If irField.isStaticArray Then
				If irField.staticArrayStructId.length Then
					If Not EmbeddedPlainStructSupported(StructById(irField.staticArrayStructId)) Then Return False
			Else If irField.staticArrayImportedStructId.length Then
					...
					If Not EmbeddedPlainImportedStructSupported(importedStatic) Then Return False
				Else If Not EmbeddedArrayElementSupported(irField.staticArrayElementType) Then
					Return False
				End If
			Else If irField.structId.length Then
				If Not EmbeddedPlainStructSupported(StructById(irField.structId)) Then Return False
			Else If irField.importedStructId.length Then
				...
				If Not EmbeddedPlainImportedStructSupported(imported) Then Return False
			Else If Not EmbeddedArrayElementSupported(irField.semanticType) And Not EmbeddedArrayStorageType(irField.semanticType) And Not irField.semanticType.Trim().ToLower().EndsWith(" ptr") Then
				Return False
			End If
		Next
		Return True
	...
	Method EmbeddedPlainImportedStructSupported:Int(importedStruct:TCompilerIrImportedStruct)
		...
		For Local importedField:TCompilerIrImportedField = EachIn importedStruct.fields
			...
			If importedField.isStaticArray Then
				If importedField.staticArrayImportedStructId.length Then
					...
					If Not EmbeddedPlainImportedStructSupported(staticImported) Then Return False
				Else If importedField.staticArrayStructId.length Then
					If Not EmbeddedPlainStructSupported(StructById(importedField.staticArrayStructId)) Then Return False
				Else If Not EmbeddedArrayElementSupported(importedField.staticArrayElementType) Then
					Return False
				End If
			Else If importedField.importedStructId.length Then
				...
				If Not EmbeddedPlainImportedStructSupported(nestedImported) Then Return False
			Else If importedField.structId.length Then
				If Not EmbeddedPlainStructSupported(StructById(importedField.structId)) Then Return False
			Else If Not IsManagedCReferenceType(importedField.semanticType) And Not EmbeddedArrayElementSupported(importedField.semanticType) And Not importedField.semanticType.Trim().ToLower().EndsWith(" ptr") Then
				Return False
			End If
		Next
		Return True
	...
	Method EmbeddedArrayStorageType:Int(typeName:String)
		Return typeName.Trim().ToLower().EndsWith("]")
	End Method

	Method EmbeddedArrayElementType:String(typeName:String)
	...
	Method EmbeddedArrayElementKind:String(typeName:String)
		Local normalized:String = typeName.Trim().ToLower()
		If normalized = "string" Then Return "BMX_EMBEDDED_ARRAY_ELEMENT_STRING"
		If EmbeddedObjectStorageType(typeName) Then Return "BMX_EMBEDDED_ARRAY_ELEMENT_OBJECT"
		Return "BMX_EMBEDDED_ARRAY_ELEMENT_VALUE"
	End Method

	Method EmbeddedObjectFieldSupported:Int(typeName:String)
		Local normalized:String = typeName.Trim().ToLower()
		If EmbeddedArrayStorageType(typeName) Then Return EmbeddedArrayElementSupported(EmbeddedArrayElementType(typeName))
		If normalized = "string" Or EmbeddedArrayElementSupported(typeName) Then Return True
		If typeName.Trim().ToLower().EndsWith(" ptr") Then Return True
		If EmbeddedObjectStorageType(typeName) Then Return True
	...
	Method EmbeddedObjectReferenceType:Int(typeName:String)
		Return classTypes.Contains(typeName.Trim().ToLower())
	End Method

	Method EmbeddedObjectStorageType:Int(typeName:String)
		Local normalized:String = typeName.Trim().ToLower()
	...
	Method EmbeddedGcRootStorageType:Int(typeName:String)
		Return typeName.Trim().ToLower() = "__pico_exception" Or typeName.Trim().ToLower() = "string" Or EmbeddedObjectStorageType(typeName) Or EmbeddedArrayStorageType(typeName) Or EmbeddedManagedStructType(typeName)
	End Method

	Method EmbeddedManagedStructType:Int(typeName:String)
		Local irStruct:TCompilerIrStruct = TCompilerIrStruct(structTypes.ValueForKey(typeName.Trim().ToLower()))
		If irStruct Then Return irStruct.containsManagedReferences And EmbeddedPlainStructSupported(irStruct)
		Local importedStruct:TCompilerIrImportedStruct = TCompilerIrImportedStruct(importedStructTypes.ValueForKey(typeName.Trim().ToLower()))
		Return importedStruct And importedStruct.containsManagedReferences And EmbeddedPlainImportedStructSupported(importedStruct)
	End Method

	Method EmbeddedRootKind:String(typeName:String)
		If typeName.Trim().ToLower() = "__pico_exception" Then Return "BMX_EMBEDDED_ROOT_EXCEPTION"
		If typeName.Trim().ToLower() = "string" Then Return "BMX_EMBEDDED_ROOT_STRING"
		If EmbeddedArrayStorageType(typeName) Then Return "BMX_EMBEDDED_ROOT_ARRAY"
		Return "BMX_EMBEDDED_ROOT_OBJECT"
	End Method
	...
	Method EmbeddedRootSlotExpression:String(typeName:String, address:String)
		If EmbeddedManagedStructType(typeName) Then
			Local irStruct:TCompilerIrStruct = TCompilerIrStruct(structTypes.ValueForKey(typeName.Trim().ToLower()))
			If irStruct Then Return "{ (void *)(" + address + "), BMX_EMBEDDED_ROOT_STRUCT, &" + EmbeddedStructDescriptorName(irStruct) + " }"
			Local importedStruct:TCompilerIrImportedStruct = TCompilerIrImportedStruct(importedStructTypes.ValueForKey(typeName.Trim().ToLower()))
			Return "{ (void *)(" + address + "), BMX_EMBEDDED_ROOT_STRUCT, &" + EmbeddedImportedStructDescriptorName(importedStruct) + " }"
		End If
		Return "{ (void *)(" + address + "), " + EmbeddedRootKind(typeName) + ", 0 }"
	End Method

	Method EmbeddedExpressionMaySafepoint:Int(expression:TCompilerIrExpression)
		...
		If addressOf Then Return EmbeddedExpressionMaySafepoint(addressOf.operand)
		Local pointerTruth:TCompilerIrPointerTruth = TCompilerIrPointerTruth(expression)
		If pointerTruth Then Return EmbeddedExpressionMaySafepoint(pointerTruth.operand)
		Local pointerBinary:TCompilerIrPointerBinary = TCompilerIrPointerBinary(expression)
		If pointerBinary Then Return EmbeddedExpressionMaySafepoint(pointerBinary.left) Or EmbeddedExpressionMaySafepoint(pointerBinary.right)
		Local unary:TCompilerIrUnary = TCompilerIrUnary(expression)
		If unary Then Return EmbeddedExpressionMaySafepoint(unary.operand)
		Local binary:TCompilerIrBinary = TCompilerIrBinary(expression)
		If binary Then Return EmbeddedExpressionMaySafepoint(binary.left) Or EmbeddedExpressionMaySafepoint(binary.right)
		Local conversion:TCompilerIrConversion = TCompilerIrConversion(expression)
		If conversion And EmbeddedSafepointFreeScalarType(conversion.semanticType) And EmbeddedSafepointFreeScalarType(conversion.operand.semanticType) Then Return EmbeddedExpressionMaySafepoint(conversion.operand)
		Local fieldAccess:TCompilerIrFieldAccess = TCompilerIrFieldAccess(expression)
		If fieldAccess Then Return EmbeddedExpressionMaySafepoint(fieldAccess.receiver)
		Local arrayLength:TCompilerIrArrayLength = TCompilerIrArrayLength(expression)
		If arrayLength Then Return EmbeddedExpressionMaySafepoint(arrayLength.receiver)
		Local stringLength:TCompilerIrStringLength = TCompilerIrStringLength(expression)
		If stringLength Then Return EmbeddedExpressionMaySafepoint(stringLength.receiver)
		Local arrayElement:TCompilerIrArrayElement = TCompilerIrArrayElement(expression)
		If arrayElement Then
			If EmbeddedExpressionMaySafepoint(arrayElement.receiver) Then Return True
			For Local index:TCompilerIrExpression = EachIn arrayElement.indexes
				If EmbeddedExpressionMaySafepoint(index) Then Return True
			Next
			Return False
		End If
		Local pointerElement:TCompilerIrPointerElement = TCompilerIrPointerElement(expression)
		If pointerElement Then Return EmbeddedExpressionMaySafepoint(pointerElement.receiver) Or EmbeddedExpressionMaySafepoint(pointerElement.index)
		Local materialize:TCompilerIrMaterialize = TCompilerIrMaterialize(expression)
		If materialize Then Return EmbeddedExpressionMaySafepoint(materialize.value) Or EmbeddedExpressionMaySafepoint(materialize.expression)
	...
	Method EmbeddedSafepointFreeScalarType:Int(typeName:String)
		Local normalized:String = typeName.Trim().ToLower()
		Select normalized
	...
	Method EmbeddedBlockMaySafepoint:Int(block:TCompilerIrBlock)
		If Not block Then Return False
		For Local statement:TCompilerIrStatement = EachIn block.statements
			If EmbeddedStatementMaySafepoint(statement) Then Return True
		Next
		Return False
	End Method

	Method EmbeddedStatementMaySafepoint:Int(statement:TCompilerIrStatement)
		If Not statement Then Return False
		Local variable:TCompilerIrVariableDeclaration = TCompilerIrVariableDeclaration(statement)
		If variable Then Return EmbeddedExpressionMaySafepoint(variable.initializer)
		Local assignment:TCompilerIrAssignment = TCompilerIrAssignment(statement)
		If assignment Then Return EmbeddedExpressionMaySafepoint(assignment.target) Or EmbeddedExpressionMaySafepoint(assignment.value)
		Local expressionStatement:TCompilerIrExpressionStatement = TCompilerIrExpressionStatement(statement)
		If expressionStatement Then Return EmbeddedExpressionMaySafepoint(expressionStatement.expression)
		Local returnStatement:TCompilerIrReturn = TCompilerIrReturn(statement)
		If returnStatement Then Return returnStatement.cleanupSteps.length > 0 Or EmbeddedExpressionMaySafepoint(returnStatement.expression)
		Local assertStatement:TCompilerIrAssert = TCompilerIrAssert(statement)
		If assertStatement Then Return EmbeddedExpressionMaySafepoint(assertStatement.condition) Or EmbeddedExpressionMaySafepoint(assertStatement.message)
		Local ifStatement:TCompilerIrIf = TCompilerIrIf(statement)
		If ifStatement Then
			If EmbeddedExpressionMaySafepoint(ifStatement.condition) Or EmbeddedBlockMaySafepoint(ifStatement.thenBody) Or EmbeddedBlockMaySafepoint(ifStatement.elseBody) Then Return True
			For Local clause:TCompilerIrConditionalClause = EachIn ifStatement.elseIfClauses
				If EmbeddedExpressionMaySafepoint(clause.condition) Or EmbeddedBlockMaySafepoint(clause.body) Then Return True
			Next
			Return False
		End If
		Local whileStatement:TCompilerIrWhile = TCompilerIrWhile(statement)
		If whileStatement Then Return EmbeddedExpressionMaySafepoint(whileStatement.condition) Or EmbeddedBlockMaySafepoint(whileStatement.body)
		Local repeatStatement:TCompilerIrRepeat = TCompilerIrRepeat(statement)
		If repeatStatement Then Return EmbeddedExpressionMaySafepoint(repeatStatement.condition) Or EmbeddedBlockMaySafepoint(repeatStatement.body)
		Local rangeStatement:TCompilerIrForRange = TCompilerIrForRange(statement)
		If rangeStatement Then
			Return EmbeddedExpressionMaySafepoint(rangeStatement.target) Or EmbeddedExpressionMaySafepoint(rangeStatement.initialValue) Or EmbeddedExpressionMaySafepoint(rangeStatement.limit) Or EmbeddedExpressionMaySafepoint(rangeStatement.stepExpression) Or EmbeddedBlockMaySafepoint(rangeStatement.body)
		End If
	...
	Method RegisterEmbeddedRootLocal:Int(variable:TCompilerIrVariableDeclaration)
		If Not currentEmbeddedRootFrame Or Not variable Or variable.storage <> "local" Or variable.callableReturnType.length Then Return False
		If variable.isStaticArray Then
			If Not EmbeddedManagedStructType(variable.staticArrayElementType) Then Return False
		Else If Not EmbeddedGcRootStorageType(variable.semanticType) Then
			Return False
		End If
	...
	Method RegisterEmbeddedExceptionRoot:String(symbolId:String, name:String, semanticType:String, source:TCompilerSourceLocation)
		...
		RegisterEmbeddedRootLocal(variable)
		Return localName
	End Method

	Method ExceptionLeaveStatement:String(indent:String)
		If EmbeddedObjectTypes() Then Return indent + "bmx_embedded_exception_leave();~n"
		Return indent + "bbExLeave();~n"
	End Method

	Method EmitEmbeddedRootLocalDeclarations:String(indent:String)
		Local result:String
	...
	Method AppendEmbeddedStaticArrayRootSlots(variable:TCompilerIrVariableDeclaration, name:String, slots:String[] Var)
		If Not variable Or Not variable.isStaticArray Or Not EmbeddedManagedStructType(variable.staticArrayElementType) Then Return
		For Local index:Int = 0 Until variable.staticArrayLength
			slots :+ [EmbeddedRootSlotExpression(variable.staticArrayElementType, "&" + name + "[" + index + "]")]
		Next
	End Method

	Method EmbeddedRootSlotExpressions:String[](includeGlobals:Int = True)
		Local slots:String[] = New String[0]
		If currentRoutine And currentRoutine.receiver And EmbeddedGcRootStorageType(currentRoutine.receiver.semanticType) Then
			Local receiverAddress:String = "&" + LocalName(currentRoutine.receiver.symbolId, currentRoutine.receiver.name)
			If EmbeddedManagedStructType(currentRoutine.receiver.semanticType) Then receiverAddress = LocalName(currentRoutine.receiver.symbolId, currentRoutine.receiver.name)
			slots :+ [EmbeddedRootSlotExpression(currentRoutine.receiver.semanticType, receiverAddress)]
		End If
		If currentRoutine Then
			For Local parameter:TCompilerIrParameter = EachIn currentRoutine.parameters
				If parameter.isStaticArray Then
					If EmbeddedManagedStructType(parameter.staticArrayElementType) Then
						For Local index:Int = 0 Until parameter.staticArrayLength
							slots :+ [EmbeddedRootSlotExpression(parameter.staticArrayElementType, "&" + LocalName(parameter.symbolId, parameter.name) + "[" + index + "]")]
						Next
					End If
					Continue
				End If
				If parameter.callableReturnType.length Or Not EmbeddedGcRootStorageType(parameter.semanticType) Then Continue
				...
				slots :+ [EmbeddedRootSlotExpression(parameter.semanticType, address)]
			Next
		End If
		For Local variable:TCompilerIrVariableDeclaration = EachIn picoRootLocalOrder
			If variable.isStaticArray Then
				AppendEmbeddedStaticArrayRootSlots(variable, LocalName(variable.symbolId, variable.name), slots)
			Else
				slots :+ [EmbeddedRootSlotExpression(variable.semanticType, "&" + LocalName(variable.symbolId, variable.name))]
			End If
		Next
		For Local temporaryId:String = EachIn temporaryOrder
			...
			If temporaryAddressValues.Contains(temporaryId) Or String(temporaryCallableReturns.ValueForKey(temporaryId)).length Or Not EmbeddedGcRootStorageType(temporaryType) Then Continue
			slots :+ [EmbeddedRootSlotExpression(temporaryType, "&" + TemporaryName(temporaryId))]
		Next
		If currentIsMain And includeGlobals Then
			For Local variable:TCompilerIrVariableDeclaration = EachIn allVariables
				...
				If variable.isStaticArray Then
					AppendEmbeddedStaticArrayRootSlots(variable, SymbolName(variable.symbolId, variable.name), slots)
				Else If EmbeddedGcRootStorageType(variable.semanticType) Then
					slots :+ [EmbeddedRootSlotExpression(variable.semanticType, "&" + SymbolName(variable.symbolId, variable.name))]
				End If
			Next
		End If
		Return slots
	...
	Method EmbeddedGlobalRootSlotExpressions:String[]()
		Local slots:String[] = New String[0]
		For Local variable:TCompilerIrVariableDeclaration = EachIn allVariables
			If Not variable Or variable.storage <> "global" Or variable.callableReturnType.length Then Continue
			If variable.isStaticArray Then
	...
	Method EmitEmbeddedRootFrameSetup:String(indent:String, includeGlobals:Int = True)
		If Not currentEmbeddedRootFrame Then Return ""
		Local slots:String[] = EmbeddedRootSlotExpressions(includeGlobals)
		Local result:String = indent + "BMXEmbeddedRootFrame bmx_embedded_root_frame;~n"
		If slots.length Then
			result :+ indent + "BMXEmbeddedRootSlot bmx_embedded_root_slots[" + slots.length + "] = { "
			For Local index:Int = 0 Until slots.length
				If index Then result :+ ", "
				result :+ slots[index]
			Next
			result :+ " };~n"
			result :+ indent + "bmx_embedded_root_frame_enter(&bmx_embedded_root_frame, bmx_embedded_root_slots, " + slots.length + ");~n"
		Else
			result :+ indent + "bmx_embedded_root_frame_enter(&bmx_embedded_root_frame, 0, 0);~n"
		End If
		Return result
	End Method

	Method EmitEmbeddedPersistentGlobalRootSetup:String(indent:String)
		Local slots:String[] = EmbeddedGlobalRootSlotExpressions()
		If Not slots.length Then Return ""
		Local result:String = indent + "static BMXEmbeddedRootFrame bmx_embedded_global_root_frame;~n"
		result :+ indent + "static BMXEmbeddedRootSlot bmx_embedded_global_root_slots[" + slots.length + "] = { "
		For Local index:Int = 0 Until slots.length
			If index Then result :+ ", "
			result :+ slots[index]
		Next
		result :+ " };~n"
		Return result + indent + "bmx_embedded_root_frame_enter(&bmx_embedded_global_root_frame, bmx_embedded_global_root_slots, " + slots.length + ");~n"
	End Method

	Method EmitEmbeddedRootFrameLeave:String(indent:String)
		If currentEmbeddedRootFrame Then Return indent + "bmx_embedded_root_frame_leave(&bmx_embedded_root_frame);~n"
		Return ""
	End Method

	Method EmbeddedTypeDescriptorName:String(irClass:TCompilerIrClass)
		Return "bmx_embedded_type_" + SafeIdentifier(irClass.classId + "_" + irClass.name)
	End Method

	Method EmbeddedImportedTypeDescriptorName:String(importedClass:TCompilerIrImportedClass)
		Return "bmx_embedded_imported_type_" + SafeIdentifier(importedClass.importedClassId + "_" + importedClass.name)
	End Method

	Method EmbeddedEnumDescriptorName:String(irEnum:TCompilerIrEnum)
		Return "bmx_embedded_enum_" + SafeIdentifier(irEnum.enumId + "_" + irEnum.name)
	End Method

	Method EmbeddedStructDescriptorName:String(irStruct:TCompilerIrStruct)
		If Not irStruct Then Return ""
		Return EmbeddedPublishedStructDescriptorName(StructName(irStruct.structId))
	End Method

	Method EmbeddedPublishedStructDescriptorName:String(abiName:String)
		Return SafeIdentifier(abiName) + "_pico_value_descriptor"
	End Method

	Method EmbeddedImportedStructDescriptorName:String(importedStruct:TCompilerIrImportedStruct)
		Return "bmx_embedded_imported_value_" + SafeIdentifier(importedStruct.importedStructId + "_" + importedStruct.name)
	End Method

	Method EmbeddedInterfaceDescriptorName:String(irInterface:TCompilerIrInterface)
		Return "bmx_embedded_interface_" + SafeIdentifier(irInterface.interfaceId + "_" + irInterface.name)
	End Method

	Method EmbeddedInterfaceDescriptorAvailable:Int(irInterface:TCompilerIrInterface)
	...
	Method EmbeddedClassSlotIndex:Int(irClass:TCompilerIrClass, slotId:String)
	...
	Method EmbeddedImportedClassSlotIndex:Int(importedClass:TCompilerIrImportedClass, slotId:String)
	...
	Method EmitEmbeddedClassForwards:String(irModule:TCompilerIrModule)
	...
	Method EmitEmbeddedImportedClassLayouts:String(irModule:TCompilerIrModule)
		If Not EmbeddedObjectTypes() Then Return ""
		Local result:String
		For Local importedClass:TCompilerIrImportedClass = EachIn irModule.importedClasses
			If Not importedClass.abiName.length Then Continue
			result :+ "struct " + importedClass.abiName + "_obj {~n    BMXEmbeddedObject object;~n"
			For Local importedField:TCompilerIrImportedField = EachIn importedClass.fields
				If importedField.isStaticArray Then
					Local staticSupported:Int
					If importedField.staticArrayImportedStructId.length Then
						staticSupported = EmbeddedPlainImportedStructSupported(TCompilerIrImportedStruct(importedStructsById.ValueForKey(importedField.staticArrayImportedStructId)))
					Else If importedField.staticArrayStructId.length Then
						staticSupported = EmbeddedPlainStructSupported(StructById(importedField.staticArrayStructId))
					Else
						staticSupported = EmbeddedArrayElementSupported(importedField.staticArrayElementType)
					End If
					...
					End If
				Else If Not importedField.callableReturnType.length And Not EmbeddedObjectFieldSupported(importedField.semanticType) Then
					AddDiagnostic("BMXC2029", TBccMessages.CBackendPicoImportedTypeFieldUnsupported(importedClass.name, importedField.name), importedField.source)
					result :+ "    uint8_t " + importedField.abiName + ";~n"
	...
	Method EmitEmbeddedVirtualPrototypes:String(irModule:TCompilerIrModule)
		If Not EmbeddedObjectTypes() Then Return ""
		Local emitted:TMap = New TMap
		Local result:String
		For Local irClass:TCompilerIrClass = EachIn irModule.classes
	...
	Method EmbeddedValueKind:String(typeName:String)
		If typeName.Trim().ToLower() = "string" Then Return "BMX_EMBEDDED_VALUE_STRING"
		If EmbeddedArrayStorageType(typeName) Then Return "BMX_EMBEDDED_VALUE_ARRAY"
		Return "BMX_EMBEDDED_VALUE_OBJECT"
	End Method

	Method EmitEmbeddedInterfaceDescriptors:String(irModule:TCompilerIrModule)
		If Not EmbeddedObjectTypes() Then Return ""
		Local result:String
		For Local importedClass:TCompilerIrImportedClass = EachIn irModule.importedClasses
			If importedClass.abiName.length Then result :+ "static const BMXEmbeddedTypeDescriptor " + EmbeddedImportedTypeDescriptorName(importedClass) + ";~n"
		Next
		...
		For Local importedClass:TCompilerIrImportedClass = EachIn irModule.importedClasses
			...
			If importedClass.baseImportedClassId.length Then
				...
				If importedBase Then importedSuperDescriptor = "&" + EmbeddedImportedTypeDescriptorName(importedBase)
			End If
			result :+ "static const BMXEmbeddedTypeDescriptor " + EmbeddedImportedTypeDescriptorName(importedClass) + " = { .name = " + CQuoted(importedClass.name) + ", .abi_name = " + CQuoted(importedClass.abiName) + ", .instance_size = (uint32_t)sizeof(struct " + importedClass.abiName + "_obj), .super = " + importedSuperDescriptor + " };~n"
		Next
		If irModule.importedClasses.length Then result :+ "~n"
		For Local irInterface:TCompilerIrInterface = EachIn irModule.interfaces
			If Not EmbeddedInterfaceDescriptorAvailable(irInterface) Then
				AddDiagnostic("BMXC2029", TBccMessages.CBackendPicoInterfaceDescriptorAbiMissing(irInterface.name), irInterface.source)
				Continue
			End If
			result :+ "static const BMXEmbeddedInterfaceDescriptor " + EmbeddedInterfaceDescriptorName(irInterface) + " = { " + CQuoted(irInterface.name) + ", " + CQuoted(irInterface.abiName) + " };~n"
		Next
		If result.length Then result :+ "~n"
		Return result
	End Method

	Method EmitEmbeddedStructDescriptors:String(irModule:TCompilerIrModule)
		If Not EmbeddedObjectTypes() Then Return ""
		Local result:String
		For Local importedStruct:TCompilerIrImportedStruct = EachIn irModule.importedStructs
			If importedStruct.containsManagedReferences And EmbeddedPlainImportedStructSupported(importedStruct) Then result :+ "static const BMXEmbeddedValueDescriptor " + EmbeddedImportedStructDescriptorName(importedStruct) + ";~n"
		Next
		For Local irStruct:TCompilerIrStruct = EachIn irModule.structs
			If EmbeddedPlainStructSupported(irStruct) Then result :+ "extern const BMXEmbeddedValueDescriptor " + EmbeddedStructDescriptorName(irStruct) + ";~n"
		Next
		If result.length Then result :+ "~n"
		For Local irStruct:TCompilerIrStruct = EachIn irModule.structs
			If Not EmbeddedPlainStructSupported(irStruct) Then Continue
			Local descriptorName:String = EmbeddedStructDescriptorName(irStruct)
			Local fields:String
			...
			For Local irField:TCompilerIrStructField = EachIn irStruct.fields
				...
				If nested And nested.containsManagedReferences Then
					kind = "BMX_EMBEDDED_VALUE_STRUCT"
					descriptor = "&" + EmbeddedStructDescriptorName(nested)
				Else If nestedImported And nestedImported.containsManagedReferences Then
					kind = "BMX_EMBEDDED_VALUE_STRUCT"
					descriptor = "&" + EmbeddedImportedStructDescriptorName(nestedImported)
				Else If IsManagedCReferenceType(fieldType) Then
					kind = EmbeddedValueKind(fieldType)
				Else
					Continue
				End If
			...
			If fieldCount Then
				result :+ "static const BMXEmbeddedValueField " + descriptorName + "_fields[" + fieldCount + "] = {~n" + fields + "};~n"
				fieldPointer = descriptorName + "_fields"
			End If
			result :+ "const BMXEmbeddedValueDescriptor " + descriptorName + " = { " + CQuoted(irStruct.name) + ", (uint32_t)sizeof(struct " + StructName(irStruct.structId) + "), " + fieldPointer + ", " + fieldCount + " };~n~n"
		Next
		For Local importedStruct:TCompilerIrImportedStruct = EachIn irModule.importedStructs
			If Not importedStruct.containsManagedReferences Or Not EmbeddedPlainImportedStructSupported(importedStruct) Then Continue
			Local descriptorName:String = EmbeddedImportedStructDescriptorName(importedStruct)
			Local fields:String
			Local fieldCount:Int
			For Local importedField:TCompilerIrImportedField = EachIn importedStruct.fields
				...
				If nested And nested.containsManagedReferences Then
					kind = "BMX_EMBEDDED_VALUE_STRUCT"
					descriptor = "&" + EmbeddedImportedStructDescriptorName(nested)
				Else If nestedLocal And nestedLocal.containsManagedReferences Then
					kind = "BMX_EMBEDDED_VALUE_STRUCT"
					descriptor = "&" + EmbeddedStructDescriptorName(nestedLocal)
				Else If IsManagedCReferenceType(fieldType) Then
					kind = EmbeddedValueKind(fieldType)
				Else
					Continue
			...
			Next
			result :+ "static const BMXEmbeddedValueField " + descriptorName + "_fields[" + fieldCount + "] = {~n" + fields + "};~n"
			result :+ "static const BMXEmbeddedValueDescriptor " + descriptorName + " = { " + CQuoted(importedStruct.name) + ", (uint32_t)sizeof(struct " + importedStruct.abiName + "), " + descriptorName + "_fields, " + fieldCount + " };~n~n"
		Next
		Return result
	End Method

	Method EmitEmbeddedStructDescriptorPrototypes:String(irModule:TCompilerIrModule)
		If Not irModule Or Not CompilerEmbeddedTarget(irModule.targetPlatform) Then Return ""
		Local result:String
		For Local irStruct:TCompilerIrStruct = EachIn irModule.structs
			If (Not irStruct.isPublished And Not irStruct.hasStableLocalAbi) Or Not EmbeddedPlainStructSupported(irStruct) Then Continue
			result :+ "extern const BMXEmbeddedValueDescriptor " + EmbeddedStructDescriptorName(irStruct) + ";~n"
		Next
		If result.length Then result :+ "~n"
		Return result
	End Method

	Method EmitEmbeddedClassLayouts:String(irModule:TCompilerIrModule)
		If Not EmbeddedObjectTypes() Then Return ""
		Local result:String
		For Local irClass:TCompilerIrClass = EachIn irModule.classes
			result :+ "struct " + ObjectName(irClass.classId) + " {~n    BMXEmbeddedObject object;~n"
			For Local irField:TCompilerIrClassField = EachIn irClass.fields
				If irField.isStaticArray Then
					Local staticSupported:Int
					If irField.staticArrayImportedStructId.length Then
						staticSupported = EmbeddedPlainImportedStructSupported(TCompilerIrImportedStruct(importedStructsById.ValueForKey(irField.staticArrayImportedStructId)))
					Else If irField.staticArrayStructId.length Then
						staticSupported = EmbeddedPlainStructSupported(StructById(irField.staticArrayStructId))
					Else
						staticSupported = EmbeddedArrayElementSupported(irField.staticArrayElementType)
					End If
					If staticSupported Then
					...
					End If
				Else If Not irField.callableReturnType.length And Not EmbeddedObjectFieldSupported(irField.semanticType) Then
			...
			For Local irField:TCompilerIrClassField = EachIn irClass.fields
				If Not irField.isStaticArray And Not irField.callableReturnType.length And EmbeddedObjectStorageType(irField.semanticType) Then referenceCount :+ 1
			Next
			Local referenceOffsets:String = "0"
			If referenceCount Then
				referenceOffsets = EmbeddedTypeDescriptorName(irClass) + "_references"
				result :+ "static const uint32_t " + referenceOffsets + "[] = {~n"
				For Local irField:TCompilerIrClassField = EachIn irClass.fields
					If irField.isStaticArray Or irField.callableReturnType.length Or Not EmbeddedObjectStorageType(irField.semanticType) Then Continue
			...
			For Local irField:TCompilerIrClassField = EachIn irClass.fields
				If Not irField.isStaticArray And Not irField.callableReturnType.length And EmbeddedArrayStorageType(irField.semanticType) Then arrayCount :+ 1
			Next
			Local arrayOffsets:String = "0"
			If arrayCount Then
				arrayOffsets = EmbeddedTypeDescriptorName(irClass) + "_arrays"
				result :+ "static const uint32_t " + arrayOffsets + "[] = {~n"
				For Local irField:TCompilerIrClassField = EachIn irClass.fields
					If irField.isStaticArray Or irField.callableReturnType.length Or Not EmbeddedArrayStorageType(irField.semanticType) Then Continue
					result :+ "    (uint32_t)offsetof(struct " + ObjectName(irClass.classId) + ", " + FieldName(irField.declaringClassId, irField.fieldId) + "),~n"
				Next
				result :+ "};~n"
			End If
			...
			If stringCount Then
				stringOffsets = EmbeddedTypeDescriptorName(irClass) + "_strings"
			...
			For Local irField:TCompilerIrClassField = EachIn irClass.fields
				...
				If fieldStruct And fieldStruct.containsManagedReferences And EmbeddedPlainStructSupported(fieldStruct) Then
					fieldDescriptor = EmbeddedStructDescriptorName(fieldStruct)
				Else If importedFieldStruct And importedFieldStruct.containsManagedReferences And EmbeddedPlainImportedStructSupported(importedFieldStruct) Then
					fieldDescriptor = EmbeddedImportedStructDescriptorName(importedFieldStruct)
				Else
					Continue
				End If
				valueFields :+ "    { (uint32_t)offsetof(struct " + ObjectName(irClass.classId) + ", " + FieldName(irField.declaringClassId, irField.fieldId) + "), " + stride + ", " + count + ", BMX_EMBEDDED_VALUE_STRUCT, &" + fieldDescriptor + " },~n"
				valueFieldCount :+ 1
			Next
			Local valueFieldName:String = "0"
			If valueFieldCount Then
				valueFieldName = EmbeddedTypeDescriptorName(irClass) + "_values"
				result :+ "static const BMXEmbeddedValueField " + valueFieldName + "[" + valueFieldCount + "] = {~n" + valueFields + "};~n"
			End If
			Local interfaceEntries:String = "0"
			If irClass.interfaceImplementations.length Then
				interfaceEntries = EmbeddedTypeDescriptorName(irClass) + "_interfaces"
				For Local implementationIndex:Int = 0 Until irClass.interfaceImplementations.length
					...
					If Not EmbeddedInterfaceDescriptorAvailable(irInterface) Then Continue
					Local interfaceMethods:String = interfaceEntries + "_" + implementationIndex
					Local methodCount:Int = implementation.slots.length
					If methodCount Then
						result :+ "static const BMXEmbeddedMethod " + interfaceMethods + "[" + methodCount + "] = {~n"
						For Local implementationSlot:TCompilerIrInterfaceImplementationSlot = EachIn implementation.slots
							If implementationSlot And implementationSlot.functionId.length Then
								result :+ "    (BMXEmbeddedMethod)" + FunctionName(implementationSlot.functionId) + ",~n"
							Else If implementationSlot And implementationSlot.functionAbiName.length Then
								result :+ "    (BMXEmbeddedMethod)" + implementationSlot.functionAbiName + ",~n"
							Else
								result :+ "    0,~n"
							End If
						Next
					...
					End If
				Next
				result :+ "static const BMXEmbeddedInterfaceEntry " + interfaceEntries + "[" + irClass.interfaceImplementations.length + "] = {~n"
				For Local implementationIndex:Int = 0 Until irClass.interfaceImplementations.length
					Local implementation:TCompilerIrInterfaceImplementation = irClass.interfaceImplementations[implementationIndex]
					Local irInterface:TCompilerIrInterface = InterfaceById(implementation.interfaceId)
					Local interfaceMethods:String = interfaceEntries + "_" + implementationIndex
					If Not implementation.slots.length Then interfaceMethods = "0"
					If EmbeddedInterfaceDescriptorAvailable(irInterface) Then
						result :+ "    { &" + EmbeddedInterfaceDescriptorName(irInterface) + ", " + interfaceMethods + ", " + implementation.slots.length + " },~n"
					Else
						result :+ "    { 0, 0, 0 },~n"
					End If
				Next
			...
			If irClass.functionSlots.length Then
				methodTable = EmbeddedTypeDescriptorName(irClass) + "_methods"
				result :+ "static const BMXEmbeddedMethod " + methodTable + "[" + irClass.functionSlots.length + "] = {~n"
				For Local slot:TCompilerIrClassFunctionSlot = EachIn irClass.functionSlots
					If slot.functionId.length Then result :+ "    (BMXEmbeddedMethod)" + FunctionName(slot.functionId) + ",~n" Else result :+ "    0,~n"
				Next
				result :+ "};~n"
			End If
			Local superDescriptor:String = "0"
			If irClass.baseClassId.length Then superDescriptor = "&" + EmbeddedTypeDescriptorName(ClassById(irClass.baseClassId))
			If irClass.baseImportedClassId.length Then
				...
				If importedBase Then superDescriptor = "&" + EmbeddedImportedTypeDescriptorName(importedBase)
			End If
			result :+ "static const BMXEmbeddedTypeDescriptor " + EmbeddedTypeDescriptorName(irClass) + " = {~n"
			...
			If EmbeddedClassHasFinalizer(irClass) Then
	...
	Method EmbeddedFinalizerName:String(irClass:TCompilerIrClass)
		Return "bmx_embedded_finalize_" + SafeIdentifier(irClass.classId + "_" + irClass.name)
	End Method

	Function EmbeddedBaseInitializerAbiName:String(abiName:String)
		Return "_" + abiName + "_EmbeddedBaseInit"
	End Function

	Function EmbeddedBaseFinalizerAbiName:String(abiName:String)
		Return "_" + abiName + "_EmbeddedBaseFinalize"
	End Function

	Method EmbeddedOwnDestructor:TCompilerIrFunction(irClass:TCompilerIrClass)
	...
	Method EmbeddedClassHasFinalizer:Int(irClass:TCompilerIrClass)
		If Not irClass Then Return False
		If EmbeddedOwnDestructor(irClass) Then Return True
		If irClass.baseClassId.length Then Return EmbeddedClassHasFinalizer(ClassById(irClass.baseClassId))
		If irClass.baseImportedClassId.length Then
			Local importedBase:TCompilerIrImportedClass = ImportedClassById(irClass.baseImportedClassId)
	...
	Method EmbeddedObjectCompareName:String(irClass:TCompilerIrClass)
	...
	Method EmbeddedObjectEqualsName:String(irClass:TCompilerIrClass)
		Return "bmx_embedded_equals_" + SafeIdentifier(irClass.classId + "_" + irClass.name)
	End Method

	Method EmbeddedObjectHookReceiverType:String(irClass:TCompilerIrClass, functionId:String)
	...
	Method EmitEmbeddedFinalizerPrototypes:String(irModule:TCompilerIrModule)
		If Not EmbeddedObjectTypes() Then Return ""
		Local result:String
		For Local irClass:TCompilerIrClass = EachIn irModule.classes
	...
	Method EmitEmbeddedFinalizers:String(irModule:TCompilerIrModule)
		If Not EmbeddedObjectTypes() Then Return ""
		Local result:String
		For Local irClass:TCompilerIrClass = EachIn irModule.classes
			If EmbeddedClassHasFinalizer(irClass) Then
				result :+ "static void " + EmbeddedFinalizerName(irClass) + "(void *object) {~n"
				Local ownDestructor:TCompilerIrFunction = EmbeddedOwnDestructor(irClass)
				If ownDestructor Then result :+ "    " + FunctionName(ownDestructor.functionId) + "((struct " + ObjectName(irClass.classId) + " *)object);~n"
				If irClass.baseClassId.length And EmbeddedClassHasFinalizer(ClassById(irClass.baseClassId)) Then result :+ "    " + EmbeddedFinalizerName(ClassById(irClass.baseClassId)) + "(object);~n"
				If irClass.baseImportedClassId.length Then
					Local importedBase:TCompilerIrImportedClass = ImportedClassById(irClass.baseImportedClassId)
					If importedBase And importedBase.destructorFunctionId.length Then result :+ "    " + EmbeddedBaseFinalizerAbiName(importedBase.abiName) + "(object);~n"
				End If
				result :+ "}~n~n"
			End If
			...
			If irClass.hashCodeFunctionId.length Then
				result :+ "static uint32_t " + EmbeddedObjectHashCodeName(irClass) + "(void *object) {~n"
				result :+ "    return " + FunctionName(irClass.hashCodeFunctionId) + "((" + EmbeddedObjectHookReceiverType(irClass, irClass.hashCodeFunctionId) + ")object);~n"
				result :+ "}~n~n"
			End If
			If irClass.equalsFunctionId.length Then
				result :+ "static int32_t " + EmbeddedObjectEqualsName(irClass) + "(void *object, void *other) {~n"
				result :+ "    return " + FunctionName(irClass.equalsFunctionId) + "((" + EmbeddedObjectHookReceiverType(irClass, irClass.equalsFunctionId) + ")object, (BMXEmbeddedObject *)other);~n"
				result :+ "}~n~n"
			End If
		Next
		Return result
	...
	Method EmitEmbeddedBaseFinalizers:String(irModule:TCompilerIrModule)
		If Not EmbeddedObjectTypes() Then Return ""
		Local result:String
		For Local irClass:TCompilerIrClass = EachIn irModule.classes
			If Not irClass.isPublished Or Not irClass.abiName.length Or Not EmbeddedClassHasFinalizer(irClass) Then Continue
			result :+ "void " + EmbeddedBaseFinalizerAbiName(irClass.abiName) + "(void *object) {~n"
			result :+ "    " + EmbeddedFinalizerName(irClass) + "(object);~n}~n~n"
		Next
		Return result
	End Method

	Method EmbeddedDefaultObjectNewName:String(irClass:TCompilerIrClass)
		...
		Return "bmx_embedded_new_" + SafeIdentifier(irClass.classId + "_" + irClass.name)
	End Method

	Method EmbeddedObjectNewStorage:String(irClass:TCompilerIrClass)
		If irClass And (irClass.isPublished Or irClass.hasStableLocalAbi) Then Return ""
		Return "static "
	End Method

	Method EmitEmbeddedObjectNewHelperPrototypes:String(irModule:TCompilerIrModule)
		If Not EmbeddedObjectTypes() Or Not irModule.classes.length Then Return ""
		Local result:String
		For Local irClass:TCompilerIrClass = EachIn irModule.classes
			result :+ EmbeddedObjectNewStorage(irClass) + "struct " + ObjectName(irClass.classId) + " *" + EmbeddedDefaultObjectNewName(irClass) + "(void);~n"
			If irClass.isPublished And irClass.abiName.length Then result :+ "void " + EmbeddedBaseInitializerAbiName(irClass.abiName) + "(struct " + ObjectName(irClass.classId) + " *object);~n"
		Next
		For Local routine:TCompilerIrFunction = EachIn irModule.functions
	...
	Method EmitEmbeddedImportedConstructorPrototypes:String(irModule:TCompilerIrModule)
		If Not EmbeddedObjectTypes() Then Return ""
		Local result:String
		For Local importedClass:TCompilerIrImportedClass = EachIn irModule.importedClasses
			If importedClass.abiName.length Then
				result :+ "extern void " + EmbeddedBaseInitializerAbiName(importedClass.abiName) + "(struct " + importedClass.abiName + "_obj *object);~n"
				If importedClass.destructorFunctionId.length Then result :+ "extern void " + EmbeddedBaseFinalizerAbiName(importedClass.abiName) + "(void *object);~n"
			End If
	...
	Method EmitEmbeddedImportedMethodPrototypes:String(irModule:TCompilerIrModule)
		If Not EmbeddedObjectTypes() Then Return ""
		Local emitted:TMap = New TMap
		Local result:String
		For Local importedClass:TCompilerIrImportedClass = EachIn irModule.importedClasses
	...
	Method EmitEmbeddedImplicitConstructors:String(irModule:TCompilerIrModule)
		If Not EmbeddedObjectTypes() Then Return ""
		Local result:String
		For Local irClass:TCompilerIrClass = EachIn irModule.classes
			...
			localNames = New TMap
			ResetTemporaries()
			Local body:String = EmitEmbeddedConstructorPrologue(irClass, "o", Null, "    ")
	...
	Method EmitEmbeddedBaseInitializers:String(irModule:TCompilerIrModule)
		If Not EmbeddedObjectTypes() Then Return ""
		Local result:String
		For Local irClass:TCompilerIrClass = EachIn irModule.classes
			...
			result :+ "void " + EmbeddedBaseInitializerAbiName(irClass.abiName) + "(struct " + ObjectName(irClass.classId) + " *object) {~n"
			result :+ "    " + constructorName + "(object);~n}~n~n"
		Next
		Return result
	End Method

	Method EmitEmbeddedObjectNewHelpers:String(irModule:TCompilerIrModule)
		If Not EmbeddedObjectTypes() Then Return ""
		Local result:String
		For Local irClass:TCompilerIrClass = EachIn irModule.classes
			Local objectType:String = "struct " + ObjectName(irClass.classId) + " *"
			result :+ EmbeddedObjectNewStorage(irClass) + objectType + EmbeddedDefaultObjectNewName(irClass) + "(void) {~n"
			result :+ "    " + objectType + "o = (" + objectType + ")&bmx_embedded_null_object;~n"
			result :+ "    BMXEmbeddedRootFrame bmx_embedded_new_root_frame;~n    BMXEmbeddedRootSlot bmx_embedded_new_root_slots[1] = { { (void *)&o, BMX_EMBEDDED_ROOT_OBJECT, 0 } };~n"
			result :+ "    bmx_embedded_root_frame_enter(&bmx_embedded_new_root_frame, bmx_embedded_new_root_slots, 1);~n"
			result :+ "    o = (" + objectType + ")bmx_embedded_object_allocate(&" + EmbeddedTypeDescriptorName(irClass) + ");~n"
			result :+ "    if ((void *)o == (void *)&bmx_embedded_null_object) { bmx_embedded_root_frame_leave(&bmx_embedded_new_root_frame); return o; }~n"
			Local constructorName:String = ConstructorName(irClass.classId)
			If irClass.defaultConstructorFunctionId.length Then constructorName = FunctionName(irClass.defaultConstructorFunctionId)
			result :+ "    " + constructorName + "(o);~n    bmx_embedded_root_frame_leave(&bmx_embedded_new_root_frame);~n    return o;~n}~n~n"
		Next
		For Local routine:TCompilerIrFunction = EachIn irModule.functions
			...
			Next
			result :+ ");~n    bmx_embedded_root_frame_leave(&bmx_embedded_new_root_frame);~n    return o;~n}~n~n"
		Next
		Return result
	End Method
	...
	Method AppendGenericClassForwards(irModule:TCompilerIrModule, result:TStringBuilder, appendTypeForwards:Int = True)
		...
		' BMXEmbeddedObject header in EmitEmbeddedImportedClassLayouts.  The generic
		' declaration below is the desktop BBClass layout and must not emit a
		' second, incompatible definition for Embedded specialization units.
		If EmbeddedObjectTypes() Then Return
		Local startLength:Int = result.Length()
	...
	Method PrepareNames(irModule:TCompilerIrModule, validateInstrumentation:Int = True)
		...
		For Local stringLiteral:TCompilerIrStringLiteral = EachIn irModule.stringLiterals
			If EmbeddedStringTypes() And stringLiteral.value.length Then
				stringNames.Insert(stringLiteral.literalId, "&bmx_embedded_string_" + SafeIdentifier(stringLiteral.literalId))
			Else If EmbeddedStringTypes() Then
				stringNames.Insert(stringLiteral.literalId, "&bmx_embedded_empty_string")
		...
		For Local externalFunction:TCompilerIrExternalFunction = EachIn irModule.externalFunctions
			...
			Local picoStringFunction:String = EmbeddedStringRuntimeFunctionName(externalFunction)
			If picoStringFunction.length Then functionName = picoStringFunction
			Local picoScalarIntrinsic:String = EmbeddedScalarIntrinsicFunctionName(externalFunction)
	...
	Method AppendEmbeddedStringLiterals(irModule:TCompilerIrModule, result:TStringBuilder)
		...
		For Local literal:TCompilerIrStringLiteral = EachIn irModule.stringLiterals
			...
			result.Append("static const uint16_t bmx_embedded_string_data_" + suffix + "[] = {")
			...
			Next
			result.Append("};~n")
			result.Append("static const BMXEmbeddedString bmx_embedded_string_" + suffix + " = { " + literal.value.length + ", bmx_embedded_string_data_" + suffix + " };~n")
		Next
		If emitted Then result.Append("~n")
	End Method

	Method AppendEmbeddedEnums(irModule:TCompilerIrModule, result:TStringBuilder)
		If Not EmbeddedStringTypes() Then Return
		For Local irEnum:TCompilerIrEnum = EachIn irModule.enums
			...
			Local descriptorName:String = EmbeddedEnumDescriptorName(irEnum)
			...
			End If
			result.Append("};~n")
			result.Append("static const BMXEmbeddedString *const " + descriptorName + "_names[" + storageCount + "] = {")
			If Not count Then
				result.Append("&bmx_embedded_empty_string")
			Else
				For Local index:Int = 0 Until count
					If index Then result.Append(",")
					Local namePointer:String = String(stringNames.ValueForKey(irEnum.values[index].nameStringLiteralId))
					If Not namePointer.length Then namePointer = "&bmx_embedded_empty_string"
					result.Append(namePointer)
				Next
			End If
			result.Append("};~n")
			Local flags:String = "0"
			If irEnum.isFlags Then flags = "BMX_EMBEDDED_ENUM_FLAG_FLAGS"
			result.Append("static const BMXEmbeddedEnumDescriptor " + descriptorName + " = { " + CQuoted(irEnum.name) + ", " + descriptorName + "_values, " + descriptorName + "_names, " + count + ", (uint16_t)sizeof(" + CType(irEnum.underlyingType, irEnum.source) + "), " + flags + " };~n~n")
		Next
	End Method
	...
	Method EmitStructLayout:String(irStruct:TCompilerIrStruct, emitted:TMap, visiting:TMap, emittedGeneric:TMap, visitingGeneric:TMap)
		...
		If EmbeddedObjectTypes() And Not EmbeddedPlainStructSupported(irStruct) Then
	...
	Method EmitStructNewHelper:String(irStruct:TCompilerIrStruct, constructor:TCompilerIrFunction)
		...
		If EmbeddedObjectTypes() And irStruct.containsManagedReferences And EmbeddedPlainStructSupported(irStruct) Then
			body :+ "    BMXEmbeddedRootFrame bmx_embedded_struct_root_frame;~n"
			body :+ "    BMXEmbeddedRootSlot bmx_embedded_struct_root_slot = { (void *)&" + selfName + ", BMX_EMBEDDED_ROOT_STRUCT, &" + EmbeddedStructDescriptorName(irStruct) + " };~n"
			body :+ "    bmx_embedded_root_frame_enter(&bmx_embedded_struct_root_frame, &bmx_embedded_struct_root_slot, 1);~n"
		End If
		For Local irField:TCompilerIrStructField = EachIn irStruct.fields
			If irField.isStaticArray Then
		...
		End If
		If EmbeddedObjectTypes() And irStruct.containsManagedReferences And EmbeddedPlainStructSupported(irStruct) Then body :+ "    bmx_embedded_root_frame_leave(&bmx_embedded_struct_root_frame);~n"
	...
	Method CDefaultValue:String(typeName:String)
		Local normalized:String = typeName.ToLower()
		If normalized = "__pico_exception" Then Return "((BMXEmbeddedException){ 0, BMX_EMBEDDED_EXCEPTION_NONE, 0 })"
		If normalized.EndsWith("]") And EmbeddedArrayTypes() Then Return "&bmx_embedded_empty_array"
		If normalized.EndsWith("]") Then Return "&bbEmptyArray"
		If normalized.StartsWith("closure<") And EmbeddedObjectTypes() Then Return "((BMXEmbeddedClosure *)&bmx_embedded_null_object)"
		...
		If normalized = "string" And EmbeddedStringTypes() Then Return "&bmx_embedded_empty_string"
		...
		If (irInterface Or opaqueInterfaceTypes.Contains(normalized)) And EmbeddedObjectTypes() Then Return "((BMXEmbeddedObject *)&bmx_embedded_null_object)"
		...
		If irClass And EmbeddedObjectTypes() Then Return "((struct " + ObjectName(irClass.classId) + " *)&bmx_embedded_null_object)"
		If irClass Then Return "((struct " + ObjectName(irClass.classId) + " *)&bbNullObject)"
		Local importedClass:TCompilerIrImportedClass = TCompilerIrImportedClass(importedClassTypes.ValueForKey(normalized))
		If importedClass And importedClass.abiName = "bbObjectClass" And EmbeddedObjectTypes() Then Return "(&bmx_embedded_null_object)"
		If importedClass And importedClass.abiName = "bbObjectClass" Then Return "((BBOBJECT)&bbNullObject)"
		If importedClass And EmbeddedObjectTypes() Then Return "((struct " + importedClass.abiName + "_obj *)&bmx_embedded_null_object)"
		If importedClass Then Return "((struct " + importedClass.abiName + "_obj *)&bbNullObject)"
		If normalized = "object" And EmbeddedObjectTypes() Then Return "(&bmx_embedded_null_object)"
	...
	Method EmitExternalPrototypes:String(irModule:TCompilerIrModule, dependencyHeadersAuthoritative:Int = False)
		...
		Next
		For Local externalFunction:TCompilerIrExternalFunction = EachIn irModule.externalFunctions
			If EmbeddedStringRuntimeFunctionName(externalFunction).length Then Continue
			If EmbeddedScalarIntrinsicFunctionName(externalFunction).length Then Continue
	...
	Method EmitFunction:String(routine:TCompilerIrFunction)
		...
		currentEmbeddedRootFrame = EmbeddedObjectTypes() And (routine.debugInstrumentation Or (currentModule And currentModule.gdbDebug) Or routine.isIteratorFactory Or routine.isIteratorMoveNext Or routine.isIteratorCurrent Or routine.isIteratorClose Or EmbeddedBlockMaySafepoint(routine.body))
		currentIsMain = routine.isGlobalEntry
		Local picoModuleInitializer:Int = currentIsMain And EmbeddedModuleUnit()
		currentDebugInstrumentation = routine.debugInstrumentation
		currentCoverageInstrumentation = routine.coverageInstrumentation
		currentDebugScope = routine.debugScope
		currentReturnType = routine.returnType
		...
		If routine.lifecycleKind = IR_LIFECYCLE_DESTRUCTOR Then
			...
			If EmbeddedObjectTypes() Then
				' The Embedded heap owns physical reclamation. Inheritance is rejected
		...
		body :+ EmitEmbeddedRootFrameLeave("    ")
		...
		End If
		result :+ EmitTemporaryDeclarations("    ")
		result :+ EmitEmbeddedRootLocalDeclarations("    ")
		If picoModuleInitializer Then
			result :+ EmitEmbeddedIncbinRegistration("    ")
			result :+ EmitEmbeddedPersistentGlobalRootSetup("    ")
		Else If currentIsMain And EmbeddedObjectTypes() Then
			result :+ "    bmx_embedded_modules_init();~n"
			result :+ EmitEmbeddedIncbinRegistration("    ")
		End If
		result :+ EmitEmbeddedRootFrameSetup("    ", Not picoModuleInitializer)
	...
	Method DebugObjectReceiver:String(receiver:String, semanticType:String, source:TCompilerSourceLocation)
		If EmbeddedObjectTypes() Then
			If currentDebugInstrumentation Or (currentModule And currentModule.gdbDebug) Then Return "((" + CType(semanticType, source) + ")bmx_embedded_object_assert((void *)" + receiver + "))"
			...
			Return "((" + CType(semanticType, source) + ")bmx_embedded_object_not_null((void *)" + receiver + "))"
		End If
	...
	Method EmitConstructorPrologue:String(irClass:TCompilerIrClass, receiverName:String, routine:TCompilerIrFunction, indent:String)
		...
		If EmbeddedObjectTypes() Then Return EmitEmbeddedConstructorPrologue(irClass, receiverName, routine, indent)
	...
	Method EmitEmbeddedConstructorPrologue:String(irClass:TCompilerIrClass, receiverName:String, routine:TCompilerIrFunction, indent:String)
		If Not irClass Then Return ""
		localNames.Insert("self", receiverName)
		Local result:String
		...
		If (Not routine Or (Not routine.chainedConstructorFunctionId.length And Not routine.chainedImportedConstructorId.length)) And irClass.baseImportedClassId.length Then
			Local importedBase:TCompilerIrImportedClass = ImportedClassById(irClass.baseImportedClassId)
			If importedBase Then result :+ indent + EmbeddedBaseInitializerAbiName(importedBase.abiName) + "((struct " + importedBase.abiName + "_obj *)" + receiverName + ");~n"
		End If
		For Local index:Int = irClass.declaredFieldStart Until irClass.declaredFieldStart + irClass.declaredFieldCount
			Local irField:TCompilerIrClassField = irClass.fields[index]
			If irField.isStaticArray Then
				...
				End If
				Local staticIndex:String = "bmx_embedded_static_field_init_" + SafeIdentifier(irField.fieldId)
				result :+ indent + "for (uint32_t " + staticIndex + " = 0; " + staticIndex + " < (uint32_t)" + irField.staticArrayLength + "; " + staticIndex + " = " + staticIndex + " + 1) {~n"
				result :+ indent + "    " + receiverName + "->" + FieldName(irField.declaringClassId, irField.fieldId) + "[" + staticIndex + "] = " + elementInitializer + ";~n"
				result :+ indent + "}~n"
				Continue
			End If
			If Not irField.callableReturnType.length And Not EmbeddedObjectFieldSupported(irField.semanticType) Then Continue
			Local initializer:String = CDefaultValue(irField.semanticType)
	...
	Method EmitStatementBody:String(statement:TCompilerIrStatement, indent:String)
		...
		If variable Then
			...
			Local name:String = LocalName(variable.symbolId, variable.name)
			localNames.Insert(variable.symbolId, name)
			If RegisterEmbeddedRootLocal(variable) Then
		...
		If returned Then
			...
			If currentIsMain And Not returned.expression Then Return CompleteStatementOutput(result, leaveScope + EmitEmbeddedRootFrameLeave(indent) + indent + "return 0;~n")
			If returned.expression Then
				Local capturedReturn:TCompilerCCapturedExpression = CaptureExpression(returned.expression)
				If currentEmbeddedRootFrame Then
					Local picoReturnName:String = "bmx_embedded_return_" + nextCleanupReturnId
					...
					Return CompleteStatementOutput(result, leaveScope + EmitEmbeddedRootFrameLeave(indent) + indent + "return " + picoReturnName + ";~n")
				End If
				If capturedReturn.nativeStrings.names.length Then
					...
					result.Append(EmitNativeStringCleanup(capturedReturn.nativeStrings, indent))
					Return CompleteStatementOutput(result, leaveScope + EmitEmbeddedRootFrameLeave(indent) + indent + "return " + returnName + ";~n")
				End If
				Return CompleteStatementOutput(result, leaveScope + EmitEmbeddedRootFrameLeave(indent) + indent + "return " + capturedReturn.expression + ";~n")
			End If
			If currentReturnType.ToLower() <> "void" Then Return CompleteStatementOutput(result, leaveScope + EmitEmbeddedRootFrameLeave(indent) + indent + "return " + CurrentReturnDefault(returned.source) + ";~n")
			Return CompleteStatementOutput(result, leaveScope + EmitEmbeddedRootFrameLeave(indent) + indent + "return;~n")
		End If
		Local yielded:TCompilerIrYield = TCompilerIrYield(statement)
		If yielded Then
		...
		If thrown Then
			If EmbeddedObjectTypes() Then
				...
				If throwType = "string" Then
					Return CompleteStatementOutput(result, indent + "bmx_embedded_exception_throw(bmx_embedded_exception_string(" + EmitExpression(thrown.expression) + "));~n")
				End If
				If EmbeddedArrayStorageType(throwType) Then
					Return CompleteStatementOutput(result, indent + "bmx_embedded_exception_throw(bmx_embedded_exception_array(" + EmitExpression(thrown.expression) + "));~n")
				End If
				If Not EmbeddedObjectStorageType(throwType) Then
					AddDiagnostic("BMXC2100", TBccMessages.CBackendPicoThrowTypeUnsupported(thrown.expression.semanticType), thrown.source)
					Return CompleteStatementOutput(result, "")
				End If
				Return CompleteStatementOutput(result, indent + "bmx_embedded_exception_throw(bmx_embedded_exception_object((BMXEmbeddedObject *)" + EmitExpression(thrown.expression) + "));~n")
			End If
				...
				For Local valueIndex:Int = 0 Until selectedCase.values.length
					...
					If selected.stringComparison Then
						If EmbeddedStringTypes() Then
							result.Append("bmx_embedded_string_equals(" + selectorName + ", " + EmitExpression(selectedCase.values[valueIndex]) + ") != 0")
						Else
		...
		Local usingStatement:TCompilerIrUsing = TCompilerIrUsing(statement)
		If usingStatement Then
			If EmbeddedObjectTypes() Then Return CompleteStatementOutput(result, EmitEmbeddedUsing(usingStatement, indent))
			If Not runtimeTypes Then
		...
		If eachStatement Then
			...
			If EmbeddedArrayTypes() Then
				If Not EmbeddedArrayElementSupported(eachStatement.elementType) Then
				...
				element = "(*((" + eachElementType + " *)bmx_embedded_array_element(" + collectionName + ", (int32_t)" + indexName + ", (uint32_t)sizeof(" + eachElementType + "))))"
			Else
			...
			Else
				...
				If EmbeddedArrayTypes() Then
					collectionType = "BMXEmbeddedArray *"
					indexType = "uint32_t"
				End If
		...
		If objectEachStatement Then
			...
			If cleanup And Not persistentEach Then
				If EmbeddedObjectTypes() Then result.Append(indent + "        bmx_embedded_exception_leave();~n") Else result.Append(indent + "        bbExLeave();~n")
				If DebugEnabled() And Not EmbeddedObjectTypes() Then result.Append(indent + "        bbOnDebugPopExState();~n")
				result.Append(indent + "    } break;~n")
				result.Append(indent + "    case 1: {~n")
				If DebugEnabled() And Not EmbeddedObjectTypes() Then result.Append(indent + "        bbOnDebugPopExState();~n")
				If EmbeddedObjectTypes() Then result.Append(indent + "        " + exceptionName + " = bmx_embedded_exception_catch();~n") Else result.Append(indent + "        " + exceptionName + " = bbExCatch();~n")
				result.Append(indent + "        " + failedName + " = 1;~n")
				result.Append(indent + "    } break;~n")
				result.Append(indent + "    }~n")
				result.Append(EmitUsingCleanup([cleanup], indent + "    "))
				If EmbeddedObjectTypes() Then result.Append(indent + "    if (" + failedName + ") bmx_embedded_exception_throw(" + exceptionName + ");~n") Else result.Append(indent + "    if (" + failedName + ") bbExThrow((BBObject *)" + exceptionName + ");~n")
	...
	Method EmitCleanupReturn:String(returned:TCompilerIrReturn, indent:String)
		...
		result :+ EmitEmbeddedRootFrameLeave(indent)
	...
	Method EmitUsingCleanup:String(resources:TCompilerIrUsingResource[], indent:String, clearResources:Int = False)
		If EmbeddedObjectTypes() Then Return EmitEmbeddedUsingCleanup(resources, indent, clearResources)
		Local result:String
	...
	Method EmitEmbeddedUsing:String(usingStatement:TCompilerIrUsing, indent:String)
		...
		Local frameName:String = "bmx_embedded_" + usingId + "_frame"
		Local failedName:String = "bmx_embedded_" + usingId + "_failed"
		Local exceptionName:String = RegisterEmbeddedExceptionRoot("pico.using.exception." + usingId, "bmx_embedded_" + usingId + "_exception", "__pico_exception", usingStatement.source)
		Local result:String = indent + "{~n"
		For Local resource:TCompilerIrUsingResource = EachIn usingStatement.resources
		...
		result :+ indent + "        bmx_embedded_exception_leave();~n"
		result :+ indent + "    } break;~n"
		result :+ indent + "    case 1: {~n"
		result :+ indent + "        " + exceptionName + " = bmx_embedded_exception_catch();~n"
		result :+ indent + "        " + failedName + " = 1;~n"
		result :+ indent + "    } break;~n"
		result :+ indent + "    }~n"
		result :+ EmitEmbeddedUsingCleanup(usingStatement.resources, indent + "    ")
		result :+ indent + "    if (" + failedName + ") bmx_embedded_exception_throw(" + exceptionName + ");~n"
		Return result + indent + "}~n"
	End Method

	Method EmitEmbeddedUsingCleanup:String(resources:TCompilerIrUsingResource[], indent:String, clearResources:Int = False)
		Local result:String
		For Local resourceIndex:Int = resources.length - 1 To 0 Step -1
			Local resource:TCompilerIrUsingResource = resources[resourceIndex]
			Local cleanupId:Int = nextTryFinallyId
			nextTryFinallyId :+ 1
			Local frameName:String = "bmx_embedded_using_close_" + cleanupId + "_frame"
			result :+ indent + "if (" + EmitCondition(resource.truth) + ") {~n"
			result :+ indent + "    BMXEmbeddedExceptionFrame " + frameName + ";~n"
			result :+ indent + "    bmx_embedded_exception_enter(&" + frameName + ");~n"
			result :+ indent + "    switch (setjmp(" + frameName + ".buffer)) {~n"
			...
			result :+ indent + "        bmx_embedded_exception_leave();~n"
			result :+ indent + "    } break;~n"
			result :+ indent + "    case 1: { (void)bmx_embedded_exception_catch(); } break;~n"
			result :+ indent + "    }~n"
			result :+ indent + "}~n"
			If clearResources And resource.variable Then result :+ indent + SymbolName(resource.variable.symbolId, resource.variable.name) + " = " + CDefaultValue(resource.variable.semanticType) + ";~n"
		Next
	...
	Method EmitTryFinally:String(guarded:TCompilerIrTry, indent:String)
		If EmbeddedObjectTypes() Then Return EmitEmbeddedTryFinally(guarded, indent)
	...
	Method EmitTryCatch:String(guarded:TCompilerIrTry, indent:String)
		If EmbeddedObjectTypes() Then Return EmitEmbeddedTryCatch(guarded, indent)
	...
	Method EmitEmbeddedTryFinally:String(guarded:TCompilerIrTry, indent:String)
		Local tryId:Int = nextTryFinallyId
		nextTryFinallyId :+ 1
		Local frameName:String = "bmx_embedded_try" + tryId + "_frame"
		Local failedName:String = "bmx_embedded_try" + tryId + "_failed"
		...
		If guarded.catches.length Then
			...
			result :+ EmitEmbeddedTryCatch(catchOnly, indent + "        ")
		Else
			result :+ EmitBlockContents(guarded.body, indent + "        ")
		End If
		result :+ indent + "        bmx_embedded_exception_leave();~n"
	...
	Method EmitEmbeddedTryCatch:String(guarded:TCompilerIrTry, indent:String)
		Local tryId:Int = nextTryFinallyId
		nextTryFinallyId :+ 1
		Local frameName:String = "bmx_embedded_catch" + tryId + "_frame"
		Local exceptionName:String = RegisterEmbeddedExceptionRoot("pico.catch.exception." + tryId, "bmx_embedded_exception_" + tryId, "__pico_exception", guarded.source)
		Local result:String = indent + "{~n"
		result :+ indent + "    BMXEmbeddedExceptionFrame " + frameName + ";~n"
		result :+ indent + "    bmx_embedded_exception_enter(&" + frameName + ");~n"
		result :+ indent + "    switch (setjmp(" + frameName + ".buffer)) {~n"
		...
		For Local catchIndex:Int = 0 Until guarded.catches.length
			...
			If catchIndex Then result :+ " else " Else result :+ indent + "        "
			result :+ "if (" + CatchCondition(guardedCatch, exceptionName) + ") {~n"
			Local catchName:String = RegisterEmbeddedExceptionRoot(guardedCatch.parameterSymbolId, guardedCatch.parameterName, guardedCatch.parameterType, guardedCatch.source)
		...
		Next
		result :+ " else {~n"
		result :+ indent + "            bmx_embedded_exception_throw(" + exceptionName + ");~n"
		result :+ indent + "        }~n"
		result :+ indent + "    } break;~n"
		result :+ indent + "    }~n"
		Return result + indent + "}~n"
	...
	Method EmitExpression:String(expression:TCompilerIrExpression)
		...
		If closureLiteral Then
			If EmbeddedObjectTypes() Then
				...
				Local picoEnvironment:String = "(BMXEmbeddedObject *)&bmx_embedded_null_object"
				If closureLiteral.environment Then picoEnvironment = "(BMXEmbeddedObject *)" + EmitExpression(closureLiteral.environment)
				Return "bmx_embedded_closure_allocate((BMXEmbeddedMethod)&" + picoTargetName + ", " + picoEnvironment + ")"
			End If
		...
		If call Then
			If EmbeddedStringTypes() And call.isExternal Then
				...
				If EmbeddedDesktopStringFunction(picoStringExternal) And Not EmbeddedStringRuntimeFunctionName(picoStringExternal).length Then
			...
			Else If call.dispatchKind = IR_CALL_DISPATCH_VIRTUAL Then
				...
				If EmbeddedObjectTypes() Then
					If call.objectSlotKind <> IR_OBJECT_SLOT_NONE Then
						Select call.objectSlotKind
							Case IR_OBJECT_SLOT_COMPARE
								Return "bmx_embedded_object_compare((void *)" + receiver + ", (void *)" + EmitExpression(call.arguments[0]) + ")"
							Case IR_OBJECT_SLOT_HASH_CODE
								Return "bmx_embedded_object_hash_code((void *)" + receiver + ")"
					...
					Local dispatchIndex:Int = EmbeddedClassSlotIndex(dispatchClass, call.classSlotId)
					Local pointerType:String = EmbeddedSlotFunctionPointerType(dispatchSlot)
		...
		If concat Then
			If EmbeddedStringTypes() Then
				Return "bmx_embedded_string_concat(" + EmitExpression(concat.left) + ", " + EmitExpression(concat.right) + ")"
			End If
		...
		If comparison Then
			...
			If EmbeddedStringTypes() Then
				If comparison.operatorText = "=" Or comparison.operatorText = "<>" Then
					comparisonCall = "bmx_embedded_string_equals(" + EmitExpression(comparison.left) + ", " + EmitExpression(comparison.right) + ")"
					If comparison.operatorText = "=" Then Return "(" + comparisonCall + " != 0)"
					Return "(" + comparisonCall + " == 0)"
				End If
				comparisonCall = "bmx_embedded_string_compare(" + EmitExpression(comparison.left) + ", " + EmitExpression(comparison.right) + ")"
		...
		If truth Then
			If truth.managedKind = IR_MANAGED_REFERENCE_STRING Or truth.managedKind = IR_MANAGED_REFERENCE_ARRAY Or truth.managedKind = IR_MANAGED_REFERENCE_OBJECT Or truth.managedKind = IR_MANAGED_REFERENCE_CLOSURE Then
				...
				If truth.managedKind = IR_MANAGED_REFERENCE_STRING And EmbeddedStringTypes() Then sentinel = "&bmx_embedded_empty_string"
				If truth.managedKind = IR_MANAGED_REFERENCE_ARRAY Then
					If EmbeddedArrayTypes() Then sentinel = "&bmx_embedded_empty_array" Else sentinel = "&bbEmptyArray"
				End If
				If truth.managedKind = IR_MANAGED_REFERENCE_OBJECT Then
					If EmbeddedObjectTypes() Then sentinel = "((" + CType(truth.operand.semanticType, truth.source) + ")&bmx_embedded_null_object)" Else sentinel = "((" + CType(truth.operand.semanticType, truth.source) + ")&bbNullObject)"
				End If
				If truth.managedKind = IR_MANAGED_REFERENCE_CLOSURE Then
					If EmbeddedObjectTypes() Then sentinel = "((BMXEmbeddedClosure *)&bmx_embedded_null_object)" Else sentinel = "((BBClosure *)&bbNullObject)"
				End If
		...
		If defaultValue Then
			Select defaultValue.managedKind
				Case IR_MANAGED_REFERENCE_STRING
					If EmbeddedStringTypes() Then Return "&bmx_embedded_empty_string"
					Return "&bbEmptyString"
				Case IR_MANAGED_REFERENCE_ARRAY
					If EmbeddedArrayTypes() Then Return "&bmx_embedded_empty_array"
					Return "&bbEmptyArray"
				Case IR_MANAGED_REFERENCE_OBJECT
					If EmbeddedObjectTypes() Then Return "((" + CType(defaultValue.semanticType, defaultValue.source) + ")&bmx_embedded_null_object)"
					Return "((" + CType(defaultValue.semanticType, defaultValue.source) + ")&bbNullObject)"
				Case IR_MANAGED_REFERENCE_CLOSURE
					If EmbeddedObjectTypes() Then Return "((BMXEmbeddedClosure *)&bmx_embedded_null_object)"
		...
		If arrayNew Then
			If EmbeddedArrayTypes() Then
				...
				End If
				If Not EmbeddedArrayElementSupported(arrayNew.elementType) Then
				...
				If arrayNew.structId.length Then
					...
					If Not EmbeddedPlainStructSupported(elementStruct) Then
				...
				Else If arrayNew.importedStructId.length Then
					...
					If Not EmbeddedPlainImportedStructSupported(importedElementStruct) Or Not importedElementStruct.elementInitializerAbiName.length Then
				...
				If arrayNew.structId.length Then
					...
					If descriptorStruct And descriptorStruct.containsManagedReferences Then valueDescriptor = "&" + EmbeddedStructDescriptorName(descriptorStruct)
				Else If arrayNew.importedStructId.length Then
					...
					If importedDescriptorStruct And importedDescriptorStruct.containsManagedReferences Then valueDescriptor = "&" + EmbeddedImportedStructDescriptorName(importedDescriptorStruct)
				End If
				Return "bmx_embedded_array_new_1d((int32_t)(" + EmitExpression(arrayNew.dimensions[0]) + "), (uint32_t)sizeof(" + CType(arrayNew.elementType, arrayNew.source) + "), " + EmbeddedArrayElementKind(arrayNew.elementType) + ", " + initializer + ", " + valueDescriptor + ")"
			End If
		...
		If stringSlice Then
			...
			End If
			If EmbeddedStringTypes() Then Return "bmx_embedded_string_slice(" + receiver + ", " + lowerBound + ", " + upperBound + ")"
		...
		If stringAsc Then
			If EmbeddedStringTypes() Then Return "bmx_embedded_string_asc(" + EmitExpression(stringAsc.receiver) + ")"
			Return "bbStringAsc(" + EmitExpression(stringAsc.receiver) + ")"
		End If
		Local stringChr:TCompilerIrStringChr = TCompilerIrStringChr(expression)
		If stringChr Then
			If EmbeddedStringTypes() Then Return "bmx_embedded_string_from_char(" + EmitExpression(stringChr.codePoint) + ")"
		...
		If arraySlice Then
			If EmbeddedArrayTypes() Then
				If Not EmbeddedArrayElementSupported(arraySlice.elementType) Then
				...
				Else If arraySlice.importedStructId.length Then
					...
					If importedDescriptorStruct And importedDescriptorStruct.containsManagedReferences Then valueDescriptor = "&" + EmbeddedImportedStructDescriptorName(importedDescriptorStruct)
				End If
				Return "bmx_embedded_array_slice(" + receiver + ", " + lowerBound + ", " + upperBound + ", (uint32_t)sizeof(" + CType(arraySlice.elementType, arraySlice.source) + "), " + EmbeddedArrayElementKind(arraySlice.elementType) + ", " + initializer + ", " + valueDescriptor + ")"
			End If
		...
		If arrayElement Then
			If EmbeddedArrayTypes() And Not arrayElement.isStaticArray Then
				If arrayElement.rank <> 1 Or arrayElement.indexes.length <> 1 Then
					...
					Return "0"
				End If
				If Not EmbeddedArrayElementSupported(arrayElement.elementType) Or arrayElement.callableReturnType.length Then
					AddDiagnostic("BMXC2028", TBccMessages.CBackendPicoArrayElementTypeUnsupported(arrayElement.elementType), arrayElement.source)
					Return "0"
				End If
				If arrayElement.structId.length And Not EmbeddedPlainStructSupported(StructById(arrayElement.structId)) Then
					...
					Return "0"
				End If
				If arrayElement.importedStructId.length And Not EmbeddedPlainImportedStructSupported(TCompilerIrImportedStruct(importedStructsById.ValueForKey(arrayElement.importedStructId))) Then
				...
				Return "(*((" + picoElementType + " *)bmx_embedded_array_element(" + EmitExpression(arrayElement.receiver) + ", (int32_t)(" + EmitExpression(arrayElement.indexes[0]) + "), (uint32_t)sizeof(" + picoElementType + "))))"
			End If
		...
		If arrayConcat Then
			If EmbeddedArrayTypes() Then
				Return "bmx_embedded_array_concat(" + EmitExpression(arrayConcat.left) + ", " + EmitExpression(arrayConcat.right) + ")"
			End If
		...
		If arrayLiteral Then
			If EmbeddedArrayTypes() Then
				If Not arrayLiteral.elements.length Then Return "&bmx_embedded_empty_array"
				If Not EmbeddedArrayElementSupported(arrayLiteral.elementType) Or arrayLiteral.callableReturnType.length Then
				...
				picoResult.Append("bmx_embedded_array_from_data(" + arrayLiteral.elements.length + ", (uint32_t)sizeof(" + CType(arrayLiteral.elementType, arrayLiteral.source) + "), " + EmbeddedArrayElementKind(arrayLiteral.elementType) + ", " + initializer + ", " + valueDescriptor + ", (" + elementDataType + "){")
			...
			If irClass Then
				If EmbeddedObjectTypes() Then
					If objectNew.dynamicClassSource Then
						...
						Return "((struct " + ObjectName(irClass.classId) + " *)&bmx_embedded_null_object)"
					End If
					...
					End If
					Return EmbeddedDefaultObjectNewName(irClass) + "()"
				End If
		...
		If interfaceCast Then
			If EmbeddedObjectTypes() Then
				...
				If EmbeddedInterfaceDescriptorAvailable(picoInterface) Then Return "((BMXEmbeddedObject *)bmx_embedded_interface_cast((void *)" + EmitExpression(interfaceCast.operand) + ", &" + EmbeddedInterfaceDescriptorName(picoInterface) + "))"
				AddDiagnostic("BMXC2029", TBccMessages.CBackendPicoInterfaceCastDescriptorMissing(), interfaceCast.source)
				Return "((BMXEmbeddedObject *)&bmx_embedded_null_object)"
			End If
		...
		If objectCast Then
			If EmbeddedObjectTypes() Then
				If objectCast.classId.length Then
					...
					If picoClass Then Return "((struct " + ObjectName(picoClass.classId) + " *)bmx_embedded_object_cast((void *)" + EmitExpression(objectCast.operand) + ", &" + EmbeddedTypeDescriptorName(picoClass) + "))"
				End If
				If objectCast.importedClassId.length Then
					Local importedEmbeddedClass:TCompilerIrImportedClass = ImportedClassById(objectCast.importedClassId)
					If importedEmbeddedClass And importedEmbeddedClass.abiName.length Then Return "((struct " + importedEmbeddedClass.abiName + "_obj *)bmx_embedded_object_cast((void *)" + EmitExpression(objectCast.operand) + ", &" + EmbeddedImportedTypeDescriptorName(importedEmbeddedClass) + "))"
				End If
	...
	Method EmitImportedObjectNew:String(objectNew:TCompilerIrObjectNew)
		...
		If EmbeddedObjectTypes() Then
			If objectNew.dynamicClassSource Then
				...
				Return "((struct " + importedClass.abiName + "_obj *)&bmx_embedded_null_object)"
			End If
	...
	Method EmitInterfaceCall:String(call:TCompilerIrCall)
		...
		If EmbeddedObjectTypes() Then
			If Not EmbeddedInterfaceDescriptorAvailable(irInterface) Then
				...
				Return "0"
			End If
			Local pointerType:String = EmbeddedInterfaceFunctionPointerType(interfaceMethod)
			...
			End If
			receiver = DebugObjectReceiver(receiver, call.receiver.semanticType, call.source)
			Local picoResult:String = "((" + pointerType + ")bmx_embedded_interface_methods((void *)" + receiver + ", &" + EmbeddedInterfaceDescriptorName(irInterface) + ", " + irInterface.methods.length + ")[" + interfaceMethodIndex + "])((BMXEmbeddedObject *)" + receiver
	...
	Method EmitImportedVirtualCall:String(call:TCompilerIrCall)
		...
		If EmbeddedObjectTypes() And receiverClass And call.objectSlotKind <> IR_OBJECT_SLOT_NONE Then
			...
			Select call.objectSlotKind
				Case IR_OBJECT_SLOT_COMPARE
					Return "bmx_embedded_object_compare((void *)" + picoReceiver + ", (void *)" + EmitExpression(call.arguments[0]) + ")"
				Case IR_OBJECT_SLOT_HASH_CODE
					Return "bmx_embedded_object_hash_code((void *)" + picoReceiver + ")"
				Case IR_OBJECT_SLOT_EQUALS
		...
		If EmbeddedObjectTypes() And receiverClass Then
			Local dispatchIndex:Int = EmbeddedImportedClassSlotIndex(receiverClass, call.classSlotId)
			...
			Local result:String = "((" + pointerType + ")bmx_embedded_type_methods((void *)" + receiver + ", &" + EmbeddedImportedTypeDescriptorName(receiverClass) + ", " + receiverClass.functionSlots.length + ")[" + dispatchIndex + "])((struct " + declaringClass.abiName + "_obj *)" + receiver
			For Local argument:TCompilerIrExpression = EachIn call.arguments
				result :+ ", " + EmitExpression(argument)
			Next
			Return result + ")"
		...
		If EmbeddedObjectTypes() Then
			Select guardedCatch.catchKind
				Case IR_CATCH_OBJECT
					Return exceptionName + ".kind == BMX_EMBEDDED_EXCEPTION_OBJECT"
				Case IR_CATCH_STRING
					Return exceptionName + ".kind == BMX_EMBEDDED_EXCEPTION_STRING"
				Case IR_CATCH_ARRAY
					Return exceptionName + ".kind == BMX_EMBEDDED_EXCEPTION_ARRAY"
				Case IR_CATCH_INTERFACE
					If guardedCatch.interfaceId.length Then
						...
						If EmbeddedInterfaceDescriptorAvailable(picoInterface) Then Return exceptionName + ".kind == BMX_EMBEDDED_EXCEPTION_OBJECT && bmx_embedded_interface_cast(" + exceptionName + ".value, &" + EmbeddedInterfaceDescriptorName(picoInterface) + ") != &bmx_embedded_null_object"
					End If
				Case IR_CATCH_CLASS
					If guardedCatch.classId.length Then
						Local picoClass:TCompilerIrClass = ClassById(guardedCatch.classId)
						If picoClass Then Return exceptionName + ".kind == BMX_EMBEDDED_EXCEPTION_OBJECT && bmx_embedded_object_cast(" + exceptionName + ".value, &" + EmbeddedTypeDescriptorName(picoClass) + ") != &bmx_embedded_null_object"
					End If
					If guardedCatch.importedClassId.length Then
						Local importedEmbeddedClass:TCompilerIrImportedClass = ImportedClassById(guardedCatch.importedClassId)
						If importedEmbeddedClass And importedEmbeddedClass.abiName.length Then Return exceptionName + ".kind == BMX_EMBEDDED_EXCEPTION_OBJECT && bmx_embedded_object_cast(" + exceptionName + ".value, &" + EmbeddedImportedTypeDescriptorName(importedEmbeddedClass) + ") != &bmx_embedded_null_object"
					End If
			End Select
	...
	Method EmitTemporaryDeclarations:String(indent:String)
		...
		For Local temporaryId:String = EachIn temporaryOrder
			...
			Else
				...
				If EmbeddedObjectTypes() And Not pointerSuffix.length And EmbeddedGcRootStorageType(semanticType) Then result :+ " = " + CDefaultValue(semanticType)
				result :+ ";~n"
			End If
		Next
		Return result
	...
	Method EmitConversion:String(conversion:TCompilerIrConversion)
		...
		If conversion.conversionKind = CONVERSION_ARRAY_TO_POINTER And conversion.arrayToPointerUsesHeapStorage Then
			If EmbeddedArrayTypes() Then
				Return "((" + CType(conversion.semanticType, conversion.source) + ")bmx_embedded_array_data(" + operand + "))"
			End If
			If Not runtimeTypes Then
		...
		If conversion.conversionKind = CONVERSION_NUMERIC_TO_STRING Then
			If EmbeddedStringTypes() Then
				Select conversion.operand.semanticType.ToLower()
					Case "byte", "short", "int" Return "bmx_embedded_string_from_int32(" + operand + ")"
					Case "uint" Return "bmx_embedded_string_from_uint32(" + operand + ")"
					Case "long" Return "bmx_embedded_string_from_int64(" + operand + ")"
					Case "ulong" Return "bmx_embedded_string_from_uint64(" + operand + ")"
					Case "size_t" Return "bmx_embedded_string_from_size(" + operand + ")"
					Case "longint" Return "bmx_embedded_string_from_long(" + operand + ")"
					Case "ulongint" Return "bmx_embedded_string_from_ulong(" + operand + ")"
					Case "wparam" Return "bmx_embedded_string_from_ulong(" + operand + ")"
					Case "lparam" Return "bmx_embedded_string_from_long(" + operand + ")"
					Case "float" Return "bmx_embedded_string_from_float_default(" + operand + ")"
					Case "double", "float64" Return "bmx_embedded_string_from_double_default(" + operand + ")"
				End Select
		...
		If conversion.conversionKind = CONVERSION_STRING_TO_NUMERIC Then
			If EmbeddedStringTypes() Then
				Select conversion.semanticType.ToLower()
					Case "byte" Return "((uint8_t)bmx_embedded_string_to_int32(" + operand + "))"
					Case "short" Return "((uint16_t)bmx_embedded_string_to_int32(" + operand + "))"
					Case "int" Return "bmx_embedded_string_to_int32(" + operand + ")"
					Case "uint" Return "bmx_embedded_string_to_uint32(" + operand + ")"
					Case "long" Return "bmx_embedded_string_to_int64(" + operand + ")"
					Case "ulong" Return "bmx_embedded_string_to_uint64(" + operand + ")"
					Case "size_t" Return "bmx_embedded_string_to_size(" + operand + ")"
					Case "longint" Return "bmx_embedded_string_to_long(" + operand + ")"
					Case "ulongint" Return "bmx_embedded_string_to_ulong(" + operand + ")"
					Case "wparam" Return "bmx_embedded_string_to_ulong(" + operand + ")"
					Case "lparam" Return "bmx_embedded_string_to_long(" + operand + ")"
					Case "float" Return "bmx_embedded_string_to_float(" + operand + ")"
					Case "double", "float64" Return "bmx_embedded_string_to_double(" + operand + ")"
				End Select
			Else If Not runtimeTypes Then
	...
	Method CType:String(typeName:String, source:TCompilerSourceLocation)
		Local normalized:String = typeName.Trim().ToLower()
		If normalized = "__pico_exception" Then Return "BMXEmbeddedException"
		If normalized.EndsWith("]") Then
			If EmbeddedArrayTypes() Then Return "BMXEmbeddedArray *"
		...
		If normalized.StartsWith("closure<") Then
			If EmbeddedObjectTypes() Then Return "BMXEmbeddedClosure *"
		...
		If irInterface Then
			...
			If EmbeddedObjectTypes() Then Return "BMXEmbeddedObject *"
		...
		Local importedClass:TCompilerIrImportedClass = TCompilerIrImportedClass(importedClassTypes.ValueForKey(normalized))
		If importedClass Then
			If EmbeddedObjectTypes() And importedClass.abiName = "bbObjectClass" Then Return "BMXEmbeddedObject *"
			...
			Return "void *"
		End If
		If normalized = "object" And EmbeddedObjectTypes() Then Return "BMXEmbeddedObject *"
		If normalized.EndsWith(" ptr") Then
		...
		If runtimeTypes Then
			...
			End Select
		End If
		If normalized = "string" And EmbeddedStringTypes() Then Return "const BMXEmbeddedString *"
	...
	Method EmitClosureCall:String(call:TCompilerIrClosureCall)
		If EmbeddedObjectTypes() Then
			...
			Local picoParameterTypes:String = "BMXEmbeddedObject *"
			...
			Next
			Local picoInvoke:String = "((" + CType(call.returnType, call.source) + " (*)(" + picoParameterTypes + "))bmx_embedded_closure_assert((void *)" + picoCallee + ")->invoke)(bmx_embedded_closure_assert((void *)" + picoCallee + ")->environment"
	...
	Method EmitEnumIntrinsic:String(intrinsic:TCompilerIrEnumIntrinsic)
		...
		If EmbeddedStringTypes() Then
			...
			If Not picoEnum Or picoEnum.isImported Then
				...
				Return "0"
			End If
			Local descriptor:String = "&" + EmbeddedEnumDescriptorName(picoEnum)
			Select intrinsic.intrinsicKind
				Case IR_ENUM_INTRINSIC_VALUES
					Return "bmx_embedded_enum_values(" + descriptor + ")"
				Case IR_ENUM_INTRINSIC_TO_STRING
					If intrinsic.receiver Then Return "bmx_embedded_enum_to_string(" + descriptor + ", (uint64_t)(" + EmitExpression(intrinsic.receiver) + "))"
				Case IR_ENUM_INTRINSIC_TRY_CONVERT
					If intrinsic.arguments.length = 2 Then Return "bmx_embedded_enum_try_convert(" + descriptor + ", (uint64_t)(" + EmitExpression(intrinsic.arguments[0]) + "), (void *)(" + EmitExpression(intrinsic.arguments[1]) + "))"
				Case IR_ENUM_INTRINSIC_FROM_STRING
					If intrinsic.arguments.length = 1 Then Return "((" + CType(picoEnum.underlyingType, intrinsic.source) + ")bmx_embedded_enum_from_string(" + descriptor + ", " + EmitExpression(intrinsic.arguments[0]) + "))"
			End Select
